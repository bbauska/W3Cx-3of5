...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~ index.html of W3Cx-3of5-HTML5.1x ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<head>
  <meta charset="utf-8" />
  ...
  <meta name="description" content="HTML5.1x - Coding Essentials &amp; Best Practices - 
	...
	HTML5 form features; Test basic APIs; Practice codiing techniques.">
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~ script function: scrollFunction() ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
  ...
  <!-- when the user clicks on the button, scroll to the top of the document. 0,0 or to top of -->
  <!-- menu button (2120 on other example) -->
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/w3c-logo.webp?raw=true"
  alt="W3C logo."
  style="width:125px;" />
...
<!--
<ol type="a">
  <li><a href="#cha-1"><strong>About W3C and the Web</strong></a><br></li>
  <li><a href="#cha-2"><strong>Why accessibility is important</strong></a><br></li>
  <li><a href="#cha-3"><strong>W3C tools</strong></a><br></li>
</ol>
-->
...
<blockquote>
<h3>1.1 <a href="#ch1-1-1"><strong>From HTML1.0 to HTML5</strong></a></h3>
<h3>1.2 <a href="#ch1-2-1"><strong>HTML5 Structural elements</strong></a></h3>
<h3>1.3 <a href="#ch1-3-1"><strong>A Blog example</strong></a></h3>
<h3>1.4 <a href="#ch1-4-1"><strong>Details and Summary elements</strong></a></h3>
...
<blockquote>
<h3>2.1 <a href="#ch2-1-1"><strong>Introduction - Module 2: HTML5 Multimedia</strong></a></h3>
...
way. We encourage you to create Web pages and apps and share them in the discussion 
forums. Have fun!</p>

<h3 id="cha-3">W3C Tools - Online Code Editors:</h3>
...
out for you.</p>
<p>Here are a few possibilities for Web editors:</p>
...
<p>JS Bin is an open source collaborative Web development debugging
tool. Most of the examples that are in this course are on JSBin.<br>
Tutorials can be found on the Web such as 
<a href="https://code.tutsplus.com/tutorials/javascript-tools-of-the-trade-jsbin--net-36843" 
target="_blank" rel="noopener noreferrer">this one</a> or on YouTube.<br>
<br>The tool is really simple, just open the link to
the provided examples, look at the code, look at the result, etc.<br>
<br>And you can modify the examples as you like, you can also modify / clone /
save / share them.<br>
<br>Keep in mind that it's always better to be logged in (it's free) if you do not want 
...
<p>Here's an article of interest if you use
CodePen: <a href="https://codepen.io/brentmiller/post/things-you-can-do-with-codepen" 
...
rel="noopener noreferrer">Dabblet</a>. Please
share your favorite tool on the discussion forum, and explain why! Share also your own 
code contributions, such as a nice canvas animation, a great looking HTML5 form, etc.</p>
...
features presented in this course using 2 resources: <a href="https://caniuse.com/" 
target="_blank" rel="noopener noreferrer">Can I Use</a> and 
<a href="https://developer.mozilla.org/en-US/" target="_blank" rel="noopener 
noreferrer">Mozilla Developer Network (MDN) Web Docs</a>.</p>
...
<a href="https://w3c.github.io/developers/" target="_blank" rel="noopener 
noreferrer">free and open source tools</a> used every day by millions of 
Web developers and Web designers.<br>All the tools listed below are Web-based, 
and are available as downloadable sources or as free services on the 
<a href="https://w3c.github.io/developers/tools/" target="_blank" 
rel="noopener noreferrer">W3C Developers tools</a> site.</p>

<h4>W3C Validator</h4>

<p>The <a href="https://validator.w3.org/" target="_blank" rel="noopener 
noreferrer">W3C validator</a> checks the 
<a href="https://validator.w3.org/docs/help.html#validation_basics" 
target="_blank">markup validity</a> of various Web document formats, such as HTML. 
Note that you are automatically directed to the <a href="https://validator.w3.org/nu/" 
target="_blank" rel="noopener noreferrer">Nu Html Checker</a> when validating an HTML5 
document.</p>

<h4>CSS Validator</h4>

<p>The <a href="https://jigsaw.w3.org/css-validator/" target="_blank" rel="noopener noreferrer">CSS
validator</a> checks Cascading Style Sheets (CSS) and (X)HTML documents that use CSS stylesheets.</p>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
...
<p>The <a href="https://validator.w3.org/i18n-checker/" target="_blank" rel="noopener 
noreferrer">W3C Internationalization Checker</a> provides information about various 
internationalization-related aspects of your page, including the HTTP headers that 
affect it. It will also report a number of issues and offer advice about how to 
resolve them.</p>

<h4>Link Checker</h4>

<p>The <a href="https://validator.w3.org/checklink" target="_blank" 
rel="noopener noreferrer">W3C
Link Checker</a> looks for issues in links, anchors and referenced objects in a 
Web page, CSS style sheet, or recursively on a whole Web site. </p>
<p>For best results, it is recommended to first ensure that the documents 
checked use valid <a href="https://validator.w3.org/" target="_blank">
(X)HTML Markup</a> and <a href="https://jigsaw.w3.org/css-validator/" 
target="_blank" rel="noopener noreferrer">CSS</a>.</p>

<h4>W3C Cheatsheet</h4>

<p>The <a href="https://www.w3.org/2009/cheatsheet/" target="_blank" rel="noopener noreferrer">W3C
cheatsheet</a> provides quick access to useful information from a variety of 
specifications published by W3C. It aims at giving in a very compact and mobile-
friendly format a compilation of useful knowledge extracted from W3C specifications, 
completed by summaries of guidelines developed at W3C, in particular Web accessibility 
...
<p>Its main feature is a lookup search box, where one can start typing a keyword and 
get a list of matching
properties/elements/attributes/functions in the above-mentioned specifications, and 
further details on those when selecting the one of interest.</p>
...
<p>If you’re looking to an easy way to dive into this standardization processes, 
check out which <a href="https://github.com/search?q=org%3Aw3c+label%3A%22good+first+issue%22+state%3Aopen&type=Issues" 
...
<p>Another approach is to go and bring feedback ideas for future technologies: 
the <a href="https://wicg.io/" target="_blank" rel="noopener noreferrer">W3C Web 
Platform Community Incubator Group</a> was built as an easy place to get started 
...
Science [MIT/LCS] in collaboration with <a href="https://home.cern/" 
target="_blank" rel="noopener noreferrer">CERN</a>, where the Web 
originated (see information on the <a href="https://www.w3.org/Daemon/" 
target="_blank" rel="noopener noreferrer">original CERN Server</a>, 
with support from DARPA and the <a href="https://ec.europa.eu/index_en.htm" 
target="_blank" rel="noopener noreferrer">European Commission</a>.</p>
<p>In April 1995, <a href="https://www.inria.fr/" target="_blank" 
rel="noopener noreferrer">Inria</a> became the first European W3C 
host, followed by <a href="https://www.keio.ac.jp/" target="_blank" 
rel="noopener noreferrer">Keio University of Japan</a> (Shonan Fujisawa 
Campus) in Asia in 1996. In 2003, <a href="https://www.ercim.eu/" 
target="_blank" rel="noopener noreferrer">ERCIM</a> took over the 
role of European W3C Host from Inria. In 2013, W3C
announced <a href="https://ev.buaa.edu.cn/" target="_blank" rel="noopener noreferrer">Beihang
University</a> as the fourth Host.</p>
<p>In addition to these four Host locations that employ W3C staff, there are 
<a href="https://www.w3.org/Consortium/Offices/staff" target="_blank" rel="noopener noreferrer">W3C
Offices</a> around the globe that support the developer communities in their 
...
<ul>
  ...
  <li>Holds 44 <a href="https://www.w3.org/groups/" target="_blank" rel="noopener 
    noreferrer">technical groups</a>, including Working and Interest Groups where 
    technical specifications are discussed and developed.</li>
...
<p>One analogy equates the Internet to a road network where the Web is a car, the email is a bicycle, etc.<br>
Read <a href="https://www.lifewire.com/difference-between-the-internet-and-the-web-2483335" 
target="_blank" rel="noopener noreferrer">this article</a> for more details about the 
difference between Internet and the Web.</p>
...
<p>Both the internet and the web serve unique purposes but work hand in
hand to provide information, entertainment, and other services to the
public.</p>
<p>The internet really is the information superhighway. It passes
through various kinds of network traffic including, FTP, IRC, and the
World Wide Web. Without it, we wouldn’t have our favorite and most
common way to access websites.</p>
<p>The internet was born in the 1960s under the name ARPAnet. It was an
...
<p>As personal computers became mainstream in the 1980s and 1990s and
the internet was opened to commercial interests, it grew exponentially.
More and more users plugged their computers into the massive network
through dial-up connections, then through faster connections such as
ISDN, cable, DSL, and other technologies. Today, the internet has grown
into a public spiderweb of interconnected devices and networks.</p>
...
the world, and has many business benefits. Access to information, including on the 
Web, is also recognized by the UN Convention on the Rights of Persons with Disabilities 
(CRPD).</p>
...
<h3 id="ch1-1-1">1.1.1 History of HTML</h3>
...
<table>
  ...
  <tr>
    <td><a href="https://html.spec.whatwg.org/multipage/sections.html#the-section-element" target="_blank" rel="noopener noreferrer">&lt;section&gt;</a></td>
  ...
  <tr>
    <td><a href="https://html.spec.whatwg.org/multipage/sections.html#the-time-element" target="_blank" rel="noopener noreferrer">&lt;time&gt;</a></td>
    <td>Used for marking up times and dates.</td>
  </tr>
  <tr>
    <td><a href="https://html.spec.whatwg.org/multipage/sections.html#the-aside-element" target="_blank" rel="noopener noreferrer">&lt;aside&gt;</a></td>
  ...
  <tr>
    <td><a href="https://html.spec.whatwg.org/multipage/sections.html#the-figure-element" target="_blank" rel="noopener noreferrer">&lt;figure&gt;</a> and <a href="https://html.spec.whatwg.org/multipage/sections.html#the-figcaption-element" target="_blank" rel="noopener noreferrer">&lt;figcaption&gt;</a></td>
    <td>Used to encapsulate a figure as a single item, and contains a caption for the figure, respectively.</td>
  </tr>
  <tr>
    <td><a href="https://html.spec.whatwg.org/multipage/sections.html#the-main-element" target="_blank" rel="noopener noreferrer">&lt;main&gt;</a></td>
...
This element is <a href="https://www.w3.org/TR/html5/grouping-content.html#the-main-element" target="_blank" rel="noopener noreferrer">part of the HTML5 recommendation</a> and an integral part of the HTML
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<h3 id="ch1-3-1">1.3.1 Mixing All Elements Together: A Blog Example</h3>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<h4>A blog example that uses the structural elements</h4>

<p>Let’s study <a href="https://jsbin.com/bucokav/edit?html,output" target="_blank" rel="noopener noreferrer">an example we put on JsBin</a> (all examples we have cooked up are
available on the jsbin.com Web site and can be modified freely: you can save your own version using the “Bins/create milestone” menu, share your version with others in the forums, etc. Don’t  hesitate to play with the source code, you will never break anything).</p>
...
<p>This is an example of one way to organize a blog. Here, we have designed the HTML page using a &lt;header&gt; element that contains the “Simple HTML5 blog” text that appears on top of the page.</p>
...
<p>Note that the H2, article, article header, etc. will be styled using
these rules.</p>
...
<p>The blog example from the previous part of the course, on the other
hand, uses a single &lt;section&gt; that contains
several &lt;article&gt; elements.</p>
<p>Indeed, we can also have a &lt;section&gt; that regroups all blog posts
per month, each one being an &lt;article&gt; element.</p>
...
<ul>
  <li>Browsers natively or browsers’ extensions, i.e. for
    ...
    for example the <a href="https://chrome.google.com/webstore/detail/table-of-contents-crx/eeknhipceeelbgdbcmchicoaoalfdnhi?hl=f" target="_blank" rel="noopener noreferrer">table-of-contents-crx extension</a> (Chrome extension). More on that in the next section of
    the course.</li>
  <li>Text to speech: <a href="https://www.w3.org/WAI/perspective-videos/speech/" target="_blank" rel="noopener noreferrer"></a></li>
...
<p>This chart from the <a href="https://html5doctor.com/" target="_blank" rel="noopener noreferrer">HTML5 Doctor Web
...
<p>These headings define a hierarchy, as shown by the default sizes given
by the browser. This hierarchy can also be used to define an outline of
the document. To illustrate this, we have used a browser extension. Here
is the result for the previous example:</p>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
...
<p>In the above outline, note that we have only used H1… H6 elements,
without any new HTML5 structural elements such
as &lt;section&gt; or &lt;article&gt;.</p>
<p>Here is a list of browser extensions you can try, for visualizing the
outline of a document:
<a href="https://chrome.google.com/webstore/detail/table-of-contents-crx/eeknhipceeelbgdbcmchicoaoalfdnhi?hl=f" target="_blank" rel="noopener noreferrer">table-of-contents-crx</a> Chrome
extension
or <a href="https://addons.mozilla.org/fr/firefox/addon/outline-sidebar/?src=search" target="_blank" rel="noopener noreferrer">this
Firefox extension</a>.
</p>
<h4>
Using headings and new sectioning elements (section, article, aside,
nav)
</h4>
...
<ul>
  <li>Always use a heading element after a sectioning element, for example &lt;section&gt;&lt;Hx&gt;…&lt;Hx&gt;…&lt;section&gt;, and
    after &lt;body&gt;, where x can be 1..6,</li>
...
<p><a href="https://jsbin.com/tolagec/1/edit?html,css,js,output" target="_blank" rel="noopener noreferrer">Online example at JsBin</a>.</p>
...
<p><b>Best practice</b>: visualizing the table of contents is useful for
debugging the structure of your page, and checking the presence of
headings after sectioning content.</p>
<p>Indeed, tools that generate the table of contents are a good way to
debug the structure of your page. Is the hierarchy correct? Is it what I
wanted when I designed my page?</p>
<p>They are also useful for checking the presence of headings in each
...
devs.</p>
<p>We have seen the different sectioning elements of HTML5, so why
didn’t we talk about the &lt;main&gt; element earlier in this part of
the course? Shouldn’t &lt;main&gt;…&lt;/main&gt; be used in place of
&lt;div class=“main”&gt;…&lt;/div&gt;?</p>
<p>The &lt;main&gt; element is supported by major modern browsers (see
the corresponding <a href="https://caniuse.com/#feat=mdn-html_elements_main" target="_blank" rel="noopener noreferrer">support
table</a> on CanIUse and <a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Element/main#Browser_compatibility" target="_blank" rel="noopener noreferrer">MDN’s brower compatibility page</a>.</p>
...
<p>And finally, here are some examples (from <a href="https://www.w3.org/TR/html5/grouping-content.html#the-main-element" target="_blank" rel="noopener noreferrer">the HTML5 specification</a>) that mix the &lt;main&gt; element with the other sectioning elements already seen in the course:</p>
...
23. &lt;/main&gt;
24.  
25. &lt;!-- other content --&gt;</pre>

</details>

<p>Here is another example (also from the specification). Here
the &lt;main&gt; element contains a &lt;nav&gt; element consisting of
links to subsections of the main content:</p>
...
“<a href="https://www.paciellogroup.com/blog/2015/09/easy-content-organisation-with-html5/" target="_blank" rel="noopener noreferrer">Easy content organisation with HTML5</a>” (24 September 2015). Steve explains
...
<ul>
  <li>This <a href="https://www.w3.org/TR/html5/grouping-content.html#the-main-element" target="_blank" rel="noopener noreferrer">document</a> has been written by the W3C HTML5 Working Group, which details the different use-cases for this element.</li>
  <li><a href="https://www.w3.org/html/wg/wiki/User:Sfaulkne/main-usecases" target="_blank" rel="noopener noreferrer">Rationale
  and use cases for standardizing a ‘main content’ HTML feature</a>.</li>
  <li>On MDN’s Web Docs: the <a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Element/main" target="_blank" rel="noopener noreferrer">main element.</a></li>
</ul>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
...
<p>A common remark from Web designers is: “we do not want a heading content displayed systematically after a &lt;nav&gt;, or an &lt;aside&gt; element…”</p>
<p><b>BEST PRACTICE #1:</b> In order to NOT display the heading content on screen the recommended technique is described in <a href="https://www.paciellogroup.com/blog/2012/05/html5-accessibility-chops-hidden-and-aria-hidden/" target="_blank" rel="noopener noreferrer">this article by Steve Faulkner</a>. Do not
use display:none or visibility:hidden in your CSS stylesheet, as in that case the heading content will never be vocalized by screen readers, and more generally by assistive technologies.</p>
<p>As an illustration of the recommended technique, see <a href="https://jsbin.com/savabo/edit?html,output" target="_blank" rel="noopener noreferrer">this JSBin version of the blog example</a> that hides the &lt;h2&gt;Navigation menu&lt;/h2&gt; from the &lt;nav&gt;…&lt;/nav&gt; element, using the CSS technique explained in the above link.</p>
<p><b>BEST PRACTICE #2:</b> It is not advised to include interactive content (links, controls etc) that is hidden offscreen it is in fact a violation of
the <a href="https://www.w3.org/TR/WCAG20/)" target="_blank" rel="noopener noreferrer">W3C WCAG 2.0 Guidelines</a>. All interactive content must have a visible focus indicator (and be on screen when focused).</p>

<h4>Embedding a table of contents and adding a &lt;main&gt; element</h4>

<p>In the previous section, we saw how to embed a table of contents using some JavaScript code borrowed from the Google Chrome HTML5 outliner extension.</p>
...
<p>As explained in the article <a href="https://www.paciellogroup.com/blog/2013/10/html5-document-outline/" target="_blank" rel="noopener noreferrer">HTML5 Document Outline</a> and
in <a href="https://www.w3.org/wiki/HTML/Usage/Headings" target="_blank" rel="noopener noreferrer">the W3C HTML Wiki</a>, it is risky to use nested H1s, as browsers do not correctly implement the “outline algorithm”.</p>
<p>The blog example uses nested H1’s. If you check it with <a href="https://validator.w3.org/nu" target="_blank" rel="noopener noreferrer">the W3C conformance checker</a>, it issues a warning: “<i>Consider using the h1 element as a top-level heading only (all h1 elements are treated as top-level headings by many screen readers and other tools).</i>”</p>
<p>While this is just a warning, we do prefer to use H1s only as top level elements, and replace the H1s we had after &lt;section&gt;, &lt;article&gt;, &lt;nav&gt; and &lt;aside&gt; elements respectively by a H2s and H3s.</p>
...
<ul>
  <li><a href="https://jsbin.com/heboke/edit?html,output" target="_blank" rel="noopener noreferrer">Check it online with this JsBin</a>.</li>
</ul>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<p>In this section, we show some “classic” CSS layout techniques for
designing an HTML page that uses the new sectioning elements.</p>
<p>We embed examples from this <a href="https://learn.shayhowe.com/html-css/positioning-content/" target="_blank" rel="noopener noreferrer">very good post about “Positioning content”</a>. This is a recommended reading as it details how to use the CSS float property to layout a Web page.</p>
<p>The 4 examples below are given “as is” to give you some hints. There are lots of other possibilities on using CSS to position element.</p>
...
<p><a href="https://jsbin.com/dufapo/edit?html,css,output" target="_blank" rel="noopener noreferrer">Also available online at JSBin</a>.</p>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
...
<p>This example uses the CSS flex property to achieve a result similar to the one shown in Example 2. There are many articles on Flexbox and we recommend those from Rachel Andrew on Smashing Magazine: “<a href="https://www.smashingmagazine.com/2018/10/flexbox-use-cases/" target="_blank" rel="noopener noreferrer">Use cases for Flexbox</a>”, “<a href="https://www.smashingmagazine.com/2018/09/flexbox-sizing-flexible-box/" target="_blank" rel="noopener noreferrer">Flexbox: how big is that flexible box</a>”, etc.</p>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
...
<ul>
  <li>An article on CSS Tricks: <a href="https://css-tricks.com/all-about-floats/" target="_blank" rel="noopener noreferrer">All
    about floats</a></li>
  <li>Old but good article on “A List Apart” (ALA): <a href="https://alistapart.com/article/css-floats-101" target="_blank" rel="noopener    noreferrer">CSS Floats 101</a></li>
  <li>Another article on Lifewire:<a href="https://www.lifewire.com/understanding-css-float-3466205" target="_blank" rel="noopener noreferrer"> Understanding CSS float</a></li>
  <li>On MDN’s Web Docs: the <a href="https://developer.mozilla.org/en-US/docs/Web/CSS/float" target="_blank" rel="noopener noreferrer">float CSS
    property</a> and the <a href="https://developer.mozilla.org/en-US/docs/Web/CSS/clear" target="_blank" rel="noopener noreferrer">clear CSS
    property</a></li>
</ul>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
...
<p>In the screenshot below, taken from the W3C specification page, the text next to the horizontal arrow is a &lt;summary&gt; element, and the text displayed when we click on the summary part, is
the &lt;details&gt; element. This is a sort of “accordion” with foldable content.</p>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
...
displayed/hidden.</p>
<p>&lt;details&gt; blocks can be embedded inside one another, like in
this <a href="https://jsbin.com/dejagi/edit?html,css,output" target="_blank" rel="noopener noreferrer">example</a>:</p>
...
<p>There are CSS pseudo classes to style this icon when it is in the open
or closed state. Support for these is still incomplete as of June 2020
(works on Google Chrome, Opera, Safari, not in FF).</p>

<h5>Example1 (see <a href="https://jsbin.com/tomehim/1/edit?html,css,output" target="_blank" rel="noopener noreferrer">online example</a>):</h5>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
...
<p>The color and background of the icon on the left are specified by the
following CSS rule, which uses the pseudo
class ::-webkit-details-marker</p>
...
<p>Once opened, the selector details [open] can style the icon
...
<p>It is also possible to change the icon itself using the CSS pseudo
class :after </p>

<h5>Example 2 (see
it <a href="https://jsbin.com/sajusop/edit?html,css,output" target="_blank" rel="noopener noreferrer">online</a>):</h5>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
...
<ul>
  <li>On CanIUse: <a href="https://caniuse.com/#feat=details" target="_blank" rel="noopener noreferrer">compatibility table for details and summary elements</a></li>
</ul>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
...
<pre>1.  We open at &lt;time&gt;10:00&lt;/time&gt; every morning.
...
5.  This recipe was published by Michel the &lt;time datetime=&quot;2020-04-16&quot;&gt;April 16, 2020&lt;/time&gt;.</pre>
...
<td>9:00 in the morning, GMT plus 5 hours 45 mins, (for example, Nepal
is 5:45 ahead of GMT</td>
</tr>
</tbody>
</table>
</div>
...
<ul>
  <li><a href="https://html.spec.whatwg.org/multipage/text-level-semantics.html#the-time-element" target="_blank" rel="noopener noreferrer">From the specification:</a></li>
  <li><a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Element/time" target="_blank" rel="noopener noreferrer">On MDN’s Web Docs:&gt;</a></li>
  <li>MDN’s browser compatibility <a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Element/time#Browser_compatibility" target="_blank" rel="noopener noreferrer">table</a> for &lt;time&gt;</li>
  <li><a href="https://www.brucelawson.co.uk/2012/best-of-time" target="_blank" rel="noopener noreferrer">Old but interesting article by Bruce Lawson:</a></li>
  <li>A CSS Tricks’ article: “<a href="https://css-tricks.com/time-element/" target="_blank" rel="noopener noreferrer">The ‘time’ element</a>”</li>
</ul>
...
<p>The HTML &lt;mark&gt; tag is used for indicating text as marked or highlighted for reference purposes, due to its relevance in another context.</p>
...
<ul>
  <li>From the specification: https://html.spec.whatwg.org/multipage/text-level-semantics.html#the-mark-element On MDN’s Web Docs: <a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Element/mark" target="_blank" rel="noopener noreferrer">https://developer.mozilla.org/en-US/docs/Web/HTML/Element/mark</a></li>
  <li>MDN’s browser compatibility <a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Element/mark#Browser_compatibility" target="_blank" rel="noopener noreferrer">table</a> for &lt;time&gt;</li>
...
<p>Here are some extracts from a Java Servlet that generate a zip file
and forces the browser to propose downloading it using a specified
name:</p>

<details>
  <summary>Click to expand!</summary>

<pre>1. protected void doGet(HttpServletRequest request, HttpServletResponse response)
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image055.webp?raw=true"
...
<p>This demo shows the use of the download attribute together with the HTML5 File, FileSystem and FileWriter APIs (to be studied later in this course) for generating on-the-fly content from JavaScript code, and proposing downloading it to a file.</p>
<p>We won’t detail this demo here, but take a look if you are curious to see what can be done with this new download attribute. As the FileWriter and FileSystem APIs are still supported only by Google Chrome (other browsers need polyfills), you will need Google Chrome to try it.</p>
<p>We have also put the simplified <a href="https://jsbin.com/muluwey/1/edit?html,css,js,output" target="_blank" rel="noopener noreferrer">source code of this demo on JSBin.com</a> for you to play with.</p>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
...
<ul>
  <li>From the specification: <a href="https://www.w3.org/TR/2014/REC-html5-20141028/links.html#downloading-resources" target="_blank" rel="noopener noreferrer">downloading resources</a>.</li>
  <li>From CanIUse: the <a href="https://caniuse.com/#feat=download" target="_blank" rel="noopener noreferrer">browser support of the download attribute</a>.</li>
</ul>

<h4>The HTML5 translate attribute</h4>

<p>HTML5 gives us a new translate attribute. This attribute is used to
limit the impact of  translation tools such
as <a href="https://translate.google.com/" target="_blank" rel="noopener noreferrer">Google Translate</a> by
prohibiting the translation of certain content. In many cases some parts
of a document should not be translated.</p>
...
<p>Both <a href="https://translate.google.com/" target="_blank" rel="noopener noreferrer">Google
translate</a> and <a href="https://www.microsofttranslator.com/" target="_blank" rel="noopener noreferrer">Microsoft
online translation services</a> already offer the ability to prevent
translation of content by adding markup to your content, although they
do it in (multiple) different ways. Hopefully, the new attribute will
help significantly by providing a standard approach.</p>
<h4>Principle: give hints to translating tools</h4>
<p><a href="https://www.w3.org/TR/html5/dom.html#the-translate-attribute" target="_blank" rel="noopener noreferrer">The
specification about the translate attribute</a> tells us
that <i>“The translate attribute is an enumerated attribute that is used
to specify whether an element’s attribute values and the values of its
Text node children are to be translated when the page is localized, or
whether to leave them unchanged.</i></p>
...
<ul>
  <li>From the specification: <a href="https://html.spec.whatwg.org/multipage/dom.html#the-translate-attribute" target="_blank" rel="noopener noreferrer">the translate attribute</a></li>
  <li>From MDN’s Web Docs: <a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes/translate" target="_blank" rel="noopener noreferrer"></a>
    <ul>
      <li>Its corresponding <a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes/translate#Browser_compatibility" target="_blank" rel="noopener noreferrer">browser compatibility table</a></li>
    </ul></li>
  <li>An article from W3C’s Internationalization Activity: <a href="https://www.w3.org/International/questions/qa-translate-flag" target="_blank" rel="noopener noreferrer">“Using HTML’s translate attribute”</a></li>
</ul>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
...
document: <a href="https://www.w3.org/TR/html-rdfa/" target="_blank" rel="noopener noreferrer">HTML+RDFa</a>, <a href="http://microformats.org/" target="_blank" rel="noopener noreferrer">microformats</a>, <a href="https://json-ld.org/" target="_blank" rel="noopener noreferrer">JSON-LD</a>,
...
microdata is <a href="https://en.wikipedia.org/wiki/Search_engine_optimization" target="_blank" rel="noopener noreferrer">Search Engine Optimization</a>(SEO).</p>
...
<pre>1.  &lt;section [itemscope itemtype=&quot;https://schema.org/Person&quot;]&gt;
...
to <a href="http://microformats.org/" target="_blank" rel="noopener noreferrer">microformats</a>, which use HTML classes, or to <a href="https://www.w3.org/TR/xhtml-rdfa-primer/" target="_blank" rel="noopener noreferrer">RDFa</a>, which doesn’t validate in HTML4 or HTML5. Because RDFa was considered to be
too hard for authors to write, microdata is HTML5’s answer to help embed semantics into html documents.</p>

<h4>External resources</h4>

<ul>
  <li><a href="https://www.w3.org/TR/microdata/" target="_blank" rel="noopener noreferrer">W3C’s HTML Microdata Working Draft</a>,</li>
  <li>MDN’s Web Docs: <a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Microdata" target="_blank" rel="noopener noreferrer">Microdata</a>,</li>
  <li>Very good <a href="https://journal.code4lib.org/articles/6400" target="_blank" rel="noopener noreferrer">Microdata</a> paper from code{4}lib journal,</li>
  <li><a href="https://dev.opera.com/articles/microdata-and-the-microdata-dom-api/" target="_blank" rel="noopener noreferrer">Microdata and the microdata DOM API</a>, old article from dev.opera.com,</li>
  <li><a href="https://diveinto.html5doctor.com/extensibility.html" target="_blank" rel="noopener noreferrer">Chapter from Mark Pilgrim’s book about microdata</a>, very detailed introduction about semantic metadata in general, contains full examples with explanations about how to describe a Person, etc.</li>
</ul>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
...
this <a href="https://developers.google.com/search/docs/guides/intro-structured-data" target="_blank" rel="noopener noreferrer">Google
page about understanding how structured data works</a>. This page
contains a link to a structured data testing tool that you can use to
see how Google recognizes the semantic data you embed in your HTML
code.</p>
...
<p>Here is what Google sees of the page. We just entered its <a href="https://output.jsbin.com/gunuzus/1" target="_blank" rel="noopener noreferrer">URL</a> in the <a href="https://developers.google.com/search/docs/guides/intro-structured-data" target="_blank" rel="noopener noreferrer">Google page about rich snippets and structured data</a>:</p>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~~ 60. microdata of the example, as seen by google (74) ~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image060.webp?raw=true"
  alt="Microdata of the example, as see by Google."
  style="width:50%;" />
...
<p>The <a href="https://foolip.org/microdatajs/live/" target="_blank" rel="noopener noreferrer">Live Microdata Web
site</a> is a bit similar to the previous one except that it shows the extracted metadata as JSON objects:</p>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 61. example live microdata (74) ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image061.webp?raw=true"
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image062.webp?raw=true"
...
<p>We will look at the itemtype attribute later. Now that we have defined a
global wrapper object/element (a Person in this case), we can  add
properties inside this element to define the first name, last name, etc.</p>

<h4>2 - Specify the vocabulary used for your microdata with the itemtype attribute of the container element</h4>

<p>HTML5 proposes semantic elements for representing sections, articles, headers, etc, but it does not propose any specific elements or attributes to describe an address, a product, a person, etc.</p>
<p>We need a special vocabulary to represent a person or a physical address. With microdata you can define your own vocabulary or better, reuse one of the existing popular vocabularies, such as <a href="https://schema.org/" target="_blank" rel="noopener noreferrer">schema.org</a>.</p>
<p>Microdata works with properties defined as name/value pairs. The names are defined in the corresponding vocabulary. For example, the vocabulary for representing a <a href="https://schema.org/Person" target="_blank" rel="noopener noreferrer">Person</a> defines a set of property names.</p>
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image063.webp?raw=true"
...
<p>The properties at <i>lines 8-12</i> refer to the address nested microdata (they are defined in the Address vocabulary, not the Person vocabulary), and “France” (<i>line 14</i>) is a property that refers to the Country vocabulary.</p>
...
<p>Here are some microdata that represent a song. In this example, at line 5 we set two different properties: genre and keywords with the same value (see the <a href="https://schema.org/MusicRecording" target="_blank" rel="noopener noreferrer">MusicRecording schema definition</a>):</p>

<pre>1.  &lt;div itemscope itemtype=&quot;https://schema.org/MusicRecording&quot;&gt;
...
<tbody>
<tr class="odd">
<td>&lt;a&gt;, &lt;area&gt;, &lt;audio&gt;, &lt;embed&gt;, &lt;iframe&gt;, &lt;img&gt;, &lt;link&gt;, &lt;object&gt;, &lt;source&gt;,
or &lt;video&gt; element</td>
<td>The data is the url in the element’s href, src, or data attribute,
as appropriate. For example, an image element inside a container of
personal contact information can be recognized as that person’s photo
and downloaded accordingly.</td>
</tr>
<tr class="even">
<td>&lt;time&gt; element</td>
<td>The data is the time in the element’s datetime attribute. This lets
you, for example, just say “last week” in your text content but still
indicate exact date and time.</td>
</tr>
<tr class="odd">
<td>&lt;meta&gt; element</td>
<td>The data is whatever appears in the content attribute of
the &lt;meta&gt; element. This is used when you need to include some
data that isn’t actually in the text of your page.</td>
</tr>
<tr class="even">
<td>anything else</td>
...
<p>To automatically generate microdata for describing persons, restaurants, movies, products, organizations, etc., there is a wide variety of microdata generators such as these listed below (but do not hesitate to search for “microdata generators” using your favorite search engine, and you will find lots!):</p>

<ul>
  <li>The <a href="https://webcode.tools/microdata-generator" target="_blank" rel="noopener noreferrer">Ultimate Microdata Generator</a></li>
  <li>The <a href="https://microdatagenerator.org/" target="_blank" rel="noopener noreferrer">MicroData Generator</a></li>
  <li>The <a href="https://technicalseo.com/tools/schema-markup-generator/" target="_blank" rel="noopener noreferrer">Schema Markup Generator (JSON-LD)</a></li>
</ul>
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<p>Here, we propose a few links to Web pages that were created by
students of previous editions of this course).</p>
<p>The students had to create a Web page to introduce themselves, with
some information including: name, job, employer, location, etc., and of
course enrich the page with microdata. They also had to follow the
best practices concerning the new structural elements, headings,
etc.</p>
<p>Click on these pages and look at the source code…</p>

<h4>Example #1</h4>

<p>Visit the <a href="https://jsbin.com/cuzipa/edit?html,css,output" target="_blank" rel="noopener noreferrer">example #1 online</a>.</p>
...
<p>View the <a href="https://jsbin.com/karemi/1/edit?html,output" target="_blank" rel="noopener noreferrer">example #2 online</a>.</p>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<h3 id="ch2-1-1">2.1.1 Multimedia - Streaming with &lt;video&gt; &amp; &lt;audio&gt; Elements</h3>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
...
Adobe <a href="https://www.adobe.com/products/flashplayer/end-of-life.html" target="_blank" rel="noopener noreferrer">no longer supports Flash Player</a> since December 31, 2020)</i></p>
...
<p>You will learn more about the different attributes of the &lt;video&gt; element later on in the course.</p>

<h4>Current browser support for the &lt;video&gt; element</h4>

<p>The &lt;video&gt; element is supported by all major browsers. See
the <a href="https://caniuse.com/video" target="_blank" rel="noopener noreferrer">support table from CanIUse.</a></p>
...
<pre>  &lt;iframe width=&quot;560&quot; height=&quot;315&quot; src=&quot;https://www.youtube.com/embed/WMFXg-kni0U&quot; title=&quot;YouTube video player&quot;
...
<p>This is one of the main problems encountered in recent years: codec support was not the same from one browser to another, for commercial/economic reasons. For example, between 2010 and 2013, Firefox
only supported the ogg/oggm format. It did not support mp3/mp4 encoding for audio/video, while Internet Explorer only supported H.264 encoding. Since 2012, things have changed with browser updates and today most popular formats are supported.</p>
<p><i>The recommended CODEC, which works in all popular browsers: H264/mp4.</i></p>

<h4>External resources</h4>

<ul>
  <li>From W3C’s specification: <a href="https://www.w3.org/TR/html52/semantics-embedded-content.html#the-video-element" target="_blank" rel="noopener noreferrer">The video element</a></li>
  <li>MDN’s Web Docs: <a href="(https://developer.mozilla.org/en-US/docs/Web/HTML/Element/video" target="_blank" rel="noopener noreferrer">&lt;video&amp;g;: The Video Embed element</a>)</li>
  <li>From Apple’s developer site: <a href="https://developer.apple.com/library/archive/documentation/AudioVideo/Conceptual/Using_HTML5_Audio_Video/ControllingMediaWithJavaScript/ControllingMediaWithJavaScript.html" target="_blank" rel="noopener noreferrer">Safari HTML5 audio and video guide</a>.</li>
  <li>Article from HTML5 Rocks: <a href="https://www.html5rocks.com/en/tutorials/video/basics/" target="_blank" rel="noopener noreferrer">Media</a></li>
</ul>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
...
<p>This course will focus on the &lt;audio&gt; element. We present the <a href="https://www.w3.org/TR/webaudio/" target="_blank" rel="noopener noreferrer">Web Audio
API</a> and other advanced HTML5 features in the <a href="https://www.edx.org/course/html5-apps-and-games" target="_blank" rel="noopener noreferrer">W3Cx HTML5 Apps and Games course</a>.</p>
<p>The attributes, event set and JavaScript API of the &lt;audio&gt; element are just a “reduced” version of the ones from the &lt;video&gt; element, and here we will only address the differences and peculiarities.</p>

<h4>The &lt;audio&gt; element, basic usage</h4>

<p>Here is a simple example (also available <a href="https://jsbin.com/yogojis/edit?html,output" target="_blank" rel="noopener noreferrer">online example from JSBin</a>):</p>
...
<p>Notice the other similarities: between the &lt;audio&gt;…&lt;audio&gt; tags, we added a text message that is displayed if the Web browser doesn’t support the &lt;audio&gt; element,
and we used several &lt;source&gt;…&lt;/source&gt; elements that link to different audio formats for the same file. The browser will use the first format it recognizes.</p>

<h4>External resources</h4>

<ul>
  <li>From W3C’s specification: <a href="https://www.w3.org/TR/html52/semantics-embedded-content.html#the-audio-element" target="_blank" rel="noopener noreferrer">The audio element</a></li>
  <li>From MDN’s Web Docs: <a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Element/audio" target="_blank" rel="noopener noreferrer">&lt;audio&gt;: The Embed Audio element</a></li>
</ul>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
...
<ul>
  ...
  <li>preload:  The preload attribute is used when autoplay is not used. It tells the browser what to do before a user plays a video. This attribute is a hint - the browser may ignore it. While autoplay and preload are mutually exclusive, if both are present, then preload is ignored. Possible values:
    <ul>
...
<p>The autoplay attribute is not recommended if your Web site targets mobile applications (actually, it is often ignored by mobile browsers), as it may consume bandwidth even if the user is not interested in watching the proposed video. If you target mobile devices, we recommend using preload=none as well, as the default value for this attribute is auto.</p>
<p><b>Best practice</b>: do not use autoplay and add preload=“none” if you target mobile devices or if you have multiple audio/video files on the same page.  For example, <a href="https://thepaciellogroup.github.io/AT-browser-tests/test-files/audio.html" target="_blank" rel="noopener noreferrer">this page</a> contains many audio elements and it does not make sense to have
them preload or autoplay.</p>

<h4>About the poster attribute</h4>

<p>If the poster attribute is missing, usually the first non-blank frame of the video will be used as the image that is shown when the video is not playing.</p>

<h4>About the autoplay attribute for general use</h4>

<p>Do not abuse of the autoplay attribute. We talked earlier about mobile applications, but even on desktop applications it’s usually a bad idea to use it (except for WebCams and for some animations with small video loops, without sound, or for sites like YouTube, with just videos).</p>
<p><b>Best practice</b>: think twice before using the autoplay attribute, even for desktop applications.</p>

<h4>Attributes of the &lt;audio&gt; element</h4>

<p>The attributes you can use with the &lt;audio&gt; element are a subset of those available for the &lt;video&gt; element. Except for the poster attribute, they are all recognized and have the
expected meanings:</p>
...
<p>You can try this example <a href="https://jsbin.com/zoquru/2/edit?html,css,output" target="_blank" rel="noopener noreferrer">online at JSBin</a>.</p>
<p>To add some styling to the basic example we saw when we introduced the &lt;audio&gt; element, we just add a &lt;figure&gt; with two children: an &lt;img&gt; and a &lt;figcaption&gt;. Inside the &lt;figcaption&gt; we add the &lt;audio&gt; element from the previous example.</p>
<p>Please move the mouse pointer over this player’s elements: (does not work in git)</p>

<details>
  <summary>HTML Click to expand!</summary>

<pre>1.   &lt;figure id=&quot;figaudio1&quot;&gt;
...
<details>
  <summary>CSS click to expand!</summary>
...
<p>See this <a href="https://jsbin.com/zoquru/4/edit?html,css,output" target="_blank" rel="noopener noreferrer">example online</a> (where you can modify the code on the fly) or just play the following video, and move the mouse pointer in and out of the video while it’s playing.</p>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
...
<p>This example uses the pseudo CSS class :hover in order to track the mouseover event. On mouseover, it uses a CSS transition property that interpolates the changes in the scale and orientation of the video element (done using a transform CSS property).</p>

<h4>The corresponding HTML source code is:</h4>

<pre>1.  &lt;video &lt;b&gt;id=&quot;w3devCampusVideo&quot;&lt;/b&gt; autoplay controls&gt;
2.  
...
<p>Below you will find two examples that show how to do this trick. The first is for a “regular” video, using the &lt;video&gt; and &lt;source&gt; elements. This technique can also be used on any YouTube embedded videos (see Example #2 below).</p>
<p>The interesting part is that we use a 100% standard (and really small and simple) JavaScript code here to handle the window resize events and we just set regular CSS properties width and height of the video element, to resize the video.</p>
...
<p>This time the video is zoomed in so that it’s much bigger than the
browser’s window. When we resize the browser, the part of the video that
is visible adapts itself. It’s not “real resize” of the video. Try
this <a href="https://thenewcode.com/777/Create-Fullscreen-HTML5-Page-Background-Video" target="_blank" rel="noopener noreferrer">example and read the explanation in this article by Dudley Storey</a>.</p>
...
<ol>
  <li><a href="https://jsbin.com/zowuqey/edit?html,css,js,output" target="_blank" rel="noopener noreferrer">Original approach</a>, using JavaScript. This solution works on any browser, so we will focus on the two following methods, based on pure CSS.</li>
  <li><a href="https://jsbin.com/sakujuv/1/edit?html,css,output" target="_blank" rel="noopener noreferrer">Using CSS 100%</a> width and height properties (no JavaScript).</li>
  <li><a href="https://jsbin.com/xureyu/3/edit?html,css,output" target="_blank" rel="noopener noreferrer">Using CSS viewport</a> units for width and height (no JavaScript).</li>
</ol>
...
<pre>1.  var video = document.createElement(&#39;video&#39;);
2.  video.src = &#39;video.mp4&#39;;
3.  video.controls = true;
4.  document.body.appendChild(video);</pre>
...
<p>The list of properties can be found at the <a href="https://www.w3.org/2010/05/video/mediaevents.html" target="_blank" rel="noopener noreferrer">W3C HTML5 Video Events and API</a> page. 
...
<p>We provide this as a quick reminder - keep in mind that the <a href="https://html.spec.whatwg.org/multipage/media.html#mediaevents" target="_blank" rel="noopener noreferrer">complete list</a> is much longer!</p>
...
<pre>1. &lt;video src=&quot;video.ogv&quot; id=&quot;myVideo&quot;&gt;
...
<p>Please see this example online, originally written by <a href="https://christianheilmann.com/" target="_blank" rel="noopener noreferrer">Chris Heilmann</a>, and tuned by us ;).</p>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
...
<p>See the <a href="https://jsbin.com/xororol/3/edit?html,output" target="_blank" rel="noopener noreferrer">example online</a> here too.</p>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
...
video will not start automatically.</p>
<p>As explained by the <a href="https://developer.apple.com/" target="_blank" rel="noopener noreferrer">Apple
Developer Web site</a>:  “The buffered property is a TimeRanges object:
an array of start and stop times, not a single value. Consider what
happens if the person watching the media uses the time scrubber to jump
forward to a point in the movie that hasn’t loaded yet—the movie stops
loading and jumps forward to the new point in time, then starts
buffering again from there. So the buffered property can contain an
array of discontinuous ranges. The example simply seeks the end of the
array and reads the last value, so it actually shows the percentage into
...
<p>This is the ultimate way of doing a real custom player: redesign your own controls using SVG shapes! This example (try it <a href="https://www.w3.org/2010/Talks/0430-www2010-plh/video-player.xhtml" target="_blank" rel="noopener noreferrer">online</a>)is given “as is” for those of you who may be curious.</p>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
...
code:</p>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<h3 id="ch2-3-1">2.3.1 HTML5 Subtitles and closed captioning</h3>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
...
<p>Please check the <a href="https://caniuse.com/mdn-html_elements_track" target="_blank" rel="noopener noreferrer">browser support</a> related to the &lt;track&gt; element support by browsers.</p>
...
<p>Here is an example of a video element that includes
a &lt;track&gt; element in the .vtt (WebVTT) format (<i>line 9</i> in
the source code shown below):</p>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
...
<p>Below is an example (<a href="https://html.spec.whatwg.org/multipage/media.html#the-track-element" target="_blank" rel="noopener noreferrer">from the specification</a>) that includes multiple &lt;track&gt; elements (subtitles for three languages and captions only for English):</p>

<details>
  <summary>Click to expand!</summary>

<pre>1. &lt;video src=&quot;brave.webm&quot;&gt;
...
<ul>
  ...
  <li>srclang:  gives the language for the text track data. The value must be a valid <a href="https://tools.ietf.org/html/bcp47" target="_blank" rel="noopener noreferrer">BCP 47 language tag</a>. This attribute must be present if <a href="https://www.w3.org/TR/html5/embedded-content-0.html#attr-track-kind" target="_blank" rel="noopener noreferrer">the element’s kind attribute</a> is in the <a href="https://www.w3.org/TR/html5/embedded-content-0.html#attr-track-kind-subtitles" target="_blank" rel="noopener noreferrer"> subtitles state</a>.</li>
</ul>

<h4>External resources</h4>

<ul>
  <li>From the HTML specification: <a href="https://html.spec.whatwg.org/multipage/media.html#the-track-element" target="_blank" rel="noopener noreferrer">The track element</a></li>
  <li>From the W3C specification: <a href="https://www.w3.org/TR/webvtt1/" target="_blank" rel="noopener noreferrer">WebVTT: The Web Video Text Tracks Format</a></li>
  <li>From MDN’s Web Docs: <a href="https://www.3playmedia.com/2017/06/30/how-to-create-a-webvtt-file/" target="_blank" rel="noopener noreferrer">WebVTT</a> and <a href="https://developer.mozilla.org/en-US/docs/Web/Guide/Audio_and_video_delivery/Adding_captions_and_subtitles_to_HTML5_video" target="_blank" rel="noopener noreferrer">Adding captions and subtitles to HTML5 video</a></li>
  <li>An article from 3playmedia: <a href="https://www.3playmedia.com/2017/06/30/how-to-create-a-webvtt-file/" target="_blank" rel="noopener noreferrer">How to create a WebVTT file</a></li>
</ul>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<h3 id="ch2-3-2">2.3.2 The WebVTT Format</h3>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<p>The "<a href="http://dev.w3.org/html5/webvtt/" target="_blank" rel="noopener noreferrer">;WebVTT: The Web Video Text Tracks Format </a>" defines files that contain text for captions and subtitles, and much more… The WebVTT files are used with the src attribute of the &lt;track&gt; element, that can be used inside a &lt;video&gt;…&lt;/video&gt;.</p>
...
<p>And here is an extract of the corresponding <a href="https://mainline.i3s.unice.fr/mooc/sintel-captions.vtt" target="_blank" rel="noopener noreferrer">sintel-captions.vtt</a> file:</p>
...
<p>This format is rather simple, but we still recommend reading <a href="https://developer.mozilla.org/fr/docs/Web/API/WebVTT_API" target="_blank" rel="noopener noreferrer">this excellent article from Mozilla Developer Network</a> that explains in detail all the different options.</p>
<p>Each “element” in this file has a starting and ending time, plus a value (the text that will be displayed), followed by a blank line (blanklines are separators between elements).</p>
<p><b>Each element is called “a cue”</b>, and may optionally have an ID that will be useful when using the track element JavaScript API, inparticular the getCueById() method of TextTrack objects.</p>
...
as <a href="https://handbrake.fr/" target="_blank" rel="noopener noreferrer">Handbrake</a> (free, open source) or <a href="https://www.erightsoft.com/SUPER.html" target="_blank" rel="noopener noreferrer">Super</a> (free). There are also online video encoding services, and you can even upload
your video to YouTube, let it encode your video in several resolutions and codecs, and use a browser extension such as <a href="https://addons.mozilla.org/fr/firefox/addon/video-downloadhelper/" target="_blank" rel="noopener noreferrer">Video DownloadHelper</a> (for Firefox)
or <a href="https://jdownloader.org/" target="_blank" rel="noopener noreferrer">JDownloader</a>, to download the video in your chosen formats.</p>
...
<p>Now, we need to create a WebVTT file for this video. How can we synchronize an English translation of what the guitar teacher says in French?</p>
<p>Many tools - both free and commercial - are available to add subtitles to a video. Most are native applications you need to install on your computer. However, a free and very practical tool is available for doing this 100% in a Web browser: <a href="https://amara.org/en/" target="_blank" rel="noopener noreferrer">amara</a>.</p>
<p>Go to the above Web site, click on the “subtitle a video” link, then follow the different tutorials/instructions. It will ask for a YouTube URL, so it’s better to first upload your video to YouTube (even in private mode). Once you have entered the URL of your video, you will have an online subtitles/caption editor. Enter your subtitles and sync them until you are happy with the results.</p>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
...
<pre>9.  00:00:11.000 --&gt; 00:00:15.000&lt;b&gt; position:5% align:start&lt;/b&gt;
10. This cue is positioned at the left side of the video.</pre>
...
<pre>1. &lt;c.myclass&gt;This cue contains the class &quot;myclass&quot;.
2. Browsers that support ::cue CSS should make it red.&lt;/c&gt;</pre>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
...
<p>Support differs from one browser to another, see <a href="https://caniuse.com/#feat=webvtt" target="_blank" rel="noopener noreferrer">this compatibility table</a> (from CanIuse). Note however that most of the enhanced players presented further on in the course provide full support.</p>
...
3.  &lt;v Jane&gt;That would make me Jane!</pre>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
...
<pre>1.  &lt;video poster=&quot;webvtt_talk.png&quot; style=&quot;width:100%&quot; preload=&quot;metadata&quot;&gt;
...
<p>Here is an example of WebVTT files with defined chapters. Each “CUE” at <i>lines 3, 7, 11</i>, … can bear any name. We use “Chapter 1, Chapter 2, Ending, etc.” but you are free to name them as you wish.</p>
<p>What makes them special is that the track has an attribute kind=“chapters”.</p>
<p>Often, the &lt;video&gt; elements rendered in standard browsers ignore chapters, but enhanced HTML5 players take them into account, and it’s not much of a stretch to make your own enhanced player with a nice chapter presentation, as we’ll see in a more advanced chapter of this course.  For example, we’ll generate a custom navigation menu, using the &lt;track&gt; JavaScript API (explained later in this section).</p>
...
25. Styled WebVTT file</pre>

</details>

<p>An example of what you can achieve using chapters, using the <a href="https://www.jwplayer.com/" target="_blank" rel="noopener noreferrer">JW Player</a></p>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
...
<ul>
  <li>Tools for converting existing file formats to WebVTT files, such as <a href="https://atelier.u-sub.net/srt2vtt/" target="_blank" rel="noopener noreferrer">Simple SubRip to WebVTT</a> converter, which is popular in the DivX/AVI/Mkv/mp4 scene. Do a quick Web search and you will get plenty of other results.</li>
  <li>Tools for creating subtitles/captions from scratch. Use these to generate a WebVTT file. You can embed the &lt;track&gt; element in your own videos, on your own Web pages, or upload the WebVTT file to YouTube.  We recommend <a href="https://amara.org/en/" target="_blank" rel="noopener noreferrer">amara</a>. It’s a free online tool that is very easy to use. There are also apps such as <a href="https://www.macupdate.com/app/mac/25826/subs-factory" target="_blank" rel="noopener noreferrer">Subs Factory</a> (Mac OS), <a href="https://jubler.org/" target="_blank" rel="noopener noreferrer">Jubler</a> or <a href="https://nikse.dk/SubtitleEdit" target="_blank" rel="noopener noreferrer">Subtitle Edit</a>) (Windows).</li>
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<p>Most “complex” HTML elements like forms, audio or video players, come with a JavaScript API that allows you to control them programmatically, customize them, etc.</p>
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<p>There are numerous “enhanced” video players; most are free and open source, some are commercial. They offer lots of features, which are listed below. Not all of these features are available in every player, this list just illustrates what can be added to the standard &lt;video&gt; element.</p>
<p>We call them “HTML5 enhanced video players” because on top of being based on the &lt;video&gt; element, they come with custom features, custom look’n’feel, chapters, etc., based on a JavaScript API that makes such customization possible.</p>

<h4>Accessible players</h4>

<p>For those of you interested in this particular topic, here is a very good resource that compares most of the players presented in this section, in terms of accessibility. This resource has links to players designed especially for people with disabilities: <a href="https://www.digitala11y.com/accessible-jquery-html5-media-players/" target="_blank" rel="noopener noreferrer">accessible media players and resources</a>.</p>
...
<p>Open source, and made for developers, <a href="https://videojs.com/" target="_blank" rel="noopener noreferrer">video.js</a> comes with many plugins (chapters, thumbnails etc.).</p>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
...
<p>Popular players such as <a href="https://www.jwplayer.com/" target="_blank" rel="noopener noreferrer">JWPlayer</a> have many explanations and examples on their Web sites, and are either free of charge or come with free versions.</p>

<h4>Interesting comparisons and reviews are available on the following Web sites:</h4>

<ul>
  <li>Comparison matrix of most of <a href="https://videosws.praegnanz.de/" target="_blank" rel="noopener noreferrer">existing HTML5 video players.</a></li>
  <li><a href="https://toppersworld.com/10-html5-video-players-as-alternatives-to-flash-player/" target="_blank" rel="noopener noreferrer">10 HTML5 video players compared.</a></li>
</ul>
...
<p>The <a href="https://www.w3.org/TR/mediacapture-streams/" target="_blank" rel="noopener noreferrer">getUserMedia
API</a> is useful for controlling a Webcam video stream.</p>
<p>This API is one component of
the <a href="https://www.w3.org/TR/webrtc/" target="_blank" rel="noopener noreferrer">WebRTC specification</a>.
When using getUserMedia, to manage a webcam with its video stream, we
will always use it in conjunction with the &lt;video&gt; element. We
could also use it with the &lt;audio&gt; element if we are only
interested in using a microphone (i.e. from a computer), or any sound
input .</p>
<p>The getUserMedia API, when dealing with video streams, is always used
in conjunction with the &lt;video&gt; element.</p>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
...
<p>The main idea is to set the srcObject attribute of
a &lt;video&gt; element to the live video stream object coming out of
the Webcam. To get this stream, you’ll have to call
the navigator.getUserMedia(params) method from the getUserMedia API,
that returns an ES6 promise (ES stands for “ECMAScript” and is the
scripting language that forms the basis of JavaScript). Do not panic if
you do not know ES6’s promises! The syntax is very simple, and you’ll
learn what you need from the provided examples.</p>
<p>The stream is passed as a parameter to the then() method returned by
the promise, as in this typical example (you can run it and see the
result by clicking on the “CodePen” logo at the top right):</p>

<details>
  <summary>Click to expand!</summary>

<pre>1. &lt;video id=&quot;myVideo&quot; autoplay&gt;Fallback msg here.&lt;/video&gt;
2. &lt;script&gt;
...
<p><b>HTTPS is mandatory:</b> for getUserMedia to work, it is mandatory to access the page that contains the JavaScript code through https://, for security reasons.</p>
<p>Support of getUserMedia/stream is <a href="https://caniuse.com/stream" target="_blank" rel="noopener noreferrer">very good in all modern browsers</a>, including mobile ones. All the video conferencing applications you use that run in a Web browser are based on this API (Google Meet, Jitsi, Bigblue Button), and even Microsoft Teams is a web application in disguise.</p>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
...
<img class="displayed"
  ...
  style="width:35%"
  alt="Resulting image of Michel Buffa using his WebCam, drinking from a ladle with two custom controls below." />
...
<p>In order to stop the Webcam and make the hardware “unlock it”, you
need to call the stop() method of the video stream.</p>
...
<p>Try this example that shows how to use the getUserMedia API. Note the
CSS effects (click on the video to cycle from one effect to
another):</p>
...
<ul>
  <li><a href="https://codepen.io/dlueth/pen/zBhwv" target="_blank" rel="noopener noreferrer">WebCam pixelization! Fun!</a></li>
  <li><a href="https://webcamtoy.com/" target="_blank" rel="noopener noreferrer">Webcam Toy</a>: video effects on Paul Neave’s webcam (using WebGL)</li>
</ul>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
...
from <a href="https://webaudiodemos.appspot.com/input/index.html" target="_blank" rel="noopener noreferrer">one of the demonstrations</a>, where the sound captured by the microphone is processed in real time. We get visualizations of the signal in real time as an animated waveform, animated frequencies or animated audiogram. If we connect an electric guitar to the sound card input, then this demonstration shows that we can recreate with WebAudio most of the classic effects used by guitarists (delay, reverb, distortion, chorus,
etc.).</p>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
...
video capture. This is done by using a <a href="https://tools.ietf.org/html/draft-alvestrand-constraints-resolution-00#page-4" target="_blank" rel="noopener noreferrer">"constraint" object </a>that is passed as a parameter to the getUserMedia(…) method. It’s just the same object we passed in the basic example: navigator.getUserMedia({video:true}, success, error) except that this time this object is a little more complex by including new properties in addition to video:true or audio:true.</p>
<p>For more information, this <a href="https://developer.mozilla.org/en-US/docs/Web/API/MediaDevices/getUserMedia" target="_blank" rel="noopener noreferrer">article on MDN about the getUserMedia API</a> gives great examples on how to set the camera resolution and/or to choose the front or back camera when using a mobile phone.</p>
...
<p>Use this <a href="https://webrtchacks.github.io/WebRTC-Camera-Resolution/" target="_blank" rel="noopener noreferrer">Web app that</a> systematically tests a set of “preferred resolutions” and
compared them to the actual resolutions returned by the browser. Remember that the requested resolution is a hint, and there is no real guarantee that your configuration will allow it.</p>
...
<pre>1.  // more on video resolution
2.  constraints = {
3.    video: {
...
22. constraints = { audio: true, video: { facingMode: { exact: &quot;environment&quot; } } }</pre>
...
<ul>
  <li>Resource: <a href="https://webrtc.github.io/samples/src/content/devices/input-output/" target="_blank" rel="noopener noreferrer">WebRTC samples: Select sources &amp; outputs</a></li>
</ul>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
...
<pre>1.  function gotDevices(deviceInfos) {
...
20. then(gotStream).then(gotDevices).catch(handleError)</pre>
...
<p>Let’s record, replay and download the video stream captured using a
...
such as <a href="https://www.videolan.org/" target="_blank" rel="noopener noreferrer">VLC</a> or online in a Web page with the &lt;video&gt; element.</p>
...
<pre>1. var recordedChunks = []; // will hold the recorded stream
...
<p>This piece of code creates a blob with the recordedChunks array. Use the URL.createObjectURL(recordedChunks) standard method to create another object that can be used as a value to set the src attribute of an HTML5 video element.</p>
...
<p>A trick consists in creating, on the fly, an invisible link with a download attribute (see Module 1) and a href attribute that points to the blob object containing the recorded stream encoded using a given
codec, then generate programmatically a click event on the link. This will force the browser to download a file of type video/webm to the hard disk.</p>

<details>
  <summary>Click to expand!</summary>
  
<pre>1.  function download() {
...
<ul>
  <li>The <a href="https://www.edx.org/course/javascript-introduction" target="_blank" rel="noopener noreferrer">JavaScript Introduction</a> course on W3Cx!</li>
  <li>Mozilla Developer Network <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide" target="_blank" rel="noopener noreferrer">has a JavaScript guide</a></li>
</ul>

<h4>What do you need? How to debug? How to catch errors?</h4>

<p>We will not look at the JavaScript syntax here, but more at
“JavaScript in the browser”, how it works, how to start writing code,
etc.</p>
<p>First of all, you need to find a way to debug your code and see
errors. If your work does not produce any results, you must know
why!</p>
<p>For that you will use <b>the dev. tools of your
browser</b>. Press <i>F12</i> in Windows or <i>cmd-alt-i</i> in Mac to
open the dev. tools, then go to the console tab: this is where errors
will be displayed, or messages of your own (use
the console.log(string) JavaScript function in the JavaScript code
embedded in your html page). In the console, you will be able to type
any JavaScript command.</p>
<p>Let’s look at <a href="https://jsbin.com/visariz/1/edit?html,output" target="_blank" rel="noopener noreferrer">this example on JS Bin</a>:</p>
...
<tbody>
  ...
  <tr class="even">
    <td>2</td>
    <td>&lt;<a href="https://december.com/html/4/element/html.html" target="_blank" rel="noopener noreferrer"><b>html lang=“en”</b></a>&gt;</td>
  </tr>
  <tr class="odd">
    <td>3</td>
    <td>&lt;<a href="https://december.com/html/4/element/head.html" target="_blank" rel="noopener noreferrer"><b>head</b></a>&gt;</td>
  </tr>
  <tr class="even">
    <td>4</td>
    <td>&lt;<a href="https://december.com/html/4/element/meta.html" target="_blank" rel="noopener noreferrer"><b>meta</b></a> charset=utf-8 /&gt;</td>
  </tr>
  <tr class="odd">
    <td>5</td>
    <td>&lt;<a href="https://december.com/html/4/element/title.html" target="_blank" rel="noopener noreferrer"><b>title</b></a>&gt;Web Audio API&lt;/<a href="https://december.com/html/4/element/title.html" target="_blank" rel="noopener noreferrer"><b>title</b></a>&gt;</td>
  </tr>
  <tr class="even">
    <td>6</td>
    <td>&lt;<a href="https://december.com/html/4/element/script.html" target="_blank" rel="noopener noreferrer"><b>script</b></a>&gt;</td>
  </tr>
  <tr class="odd">
    <td>7</td>
  ...
  <tr class="odd">
    <td>13</td>
    <td>&lt;/<a href="https://december.com/html/4/element/html.html" target="_blank" rel="noopener noreferrer"><b>html</b></a>&gt;</td>
  </tr>
</tbody>
</table>
</div>
...
<p>Some of you may not be used to “asynchronous programming”, “callbacks” etc. We recommend to read <a href="https://en.wikipedia.org/wiki/Callback_%28computer_programming%29" target="_blank" rel="noopener noreferrer">this article on WikiPedia</a> and <a href="https://stackoverflow.com/questions/8736378/what-is-a-callback-in-java" target="_blank" rel="noopener noreferrer">this thread on StackOverflow</a>.</p><!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<h3 id="ch3-2-2">3.2.2 The &lt;canvas&gt; Element</h3>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 121. canvas element logo (139) ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image121.webp?raw=true"
  style="width:10%"
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image122.webp?raw=true"
  style="width:40%"
...
href="http://www.creativebloq.com/design-tools/data-visualization-712402" target="_blank" rel="noopener noreferrer">Data visualization</a>:</p>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~ 123. html5 data visualization (142) ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image123.webp?raw=true"
  style="width:50%"
  alt="html5 data visualization, bar graphs." />

<h4>Example #3</h4>

<p>A version of the <a href="https://intersoft.itch.io/galaxian" target="_blank" rel="noopener noreferrer">arcade game Galaxian</a>, that runs at 60 frames per second in an HTML5 canvas element:</p>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~ 124. A version of the game Galaxian that runs at 60 frames/s in a canvas. (142) ~~~~~~-->
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image124.webp?raw=true"
  style="width:50%"
  alt="A version of the game Galaxian that runs at 60 frames/s in a canvas." />

<p>Performance is  good and animation is generally very smooth, since most Web browsers (mobile and desktop) support hardware acceleration.</p>
<p><b>Note</b>: 3D drawing using the WebGL API is also possible in a &lt;canvas&gt;, but will not be covered in this course. For the most curious among you, please have a look at the two popular libraries for doing 3D drawing/animation in a &lt;canvas&gt;: <a href="https://www.babylonjs.com/" target="_blank" rel="noopener noreferrer">BabylonJS</a> and <a href="https://threejs.org/" target="_blank" rel="noopener noreferrer">ThreeJS</a>.</p>

<h4>External resources</h4>

<ul>
  <li>Comprehensive <a href="https://www.html5canvastutorials.com/" target="_blank" rel="noopener noreferrer">HTML5 canvas tutorials</a></li>
  <li>An <a href="https://joshondesign.com/p/books/canvasdeepdive/title.html" target="_blank" rel="noopener noreferrer">HTML Canvas Deep Dive</a></li>
  <li>MDN’s Web docs: <a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Element/canvas" target="_blank" rel="noopener noreferrer">&lt;canvas&gt;: The Graphics Canvas element</a></li>
  <li>The &lt;canvas&gt; element is well supported by browsers:<br>
  <ul>
    <li>CanIUse: <a href="https://caniuse.com/canvas" target="_blank" rel="noopener noreferrer">browser support table</a></li>
    <li>MDN’s <a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Element/canvas#Browser_compatibility" target="_blank" rel="noopener noreferrer">compatibility table of &lt;canvas&gt;</a></li>
  </ul>
  </li>
</ul>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<p>The dynamic nature of the &lt;canvas&gt; element has made it difficult to use in applications that need to be accessible to people with disabilities. To be accessible, it must meet the following
principles:</p>
...
<ul>
  <li>An article on <a href="https://www.creativebloq.com/web-design/canvas-element-accessibility-41514740" target="_blank" rel="noopener noreferrer">What the canvas element means for accessibility</a></li>
  <li>From the W3C wiki: <a href="https://www.w3.org/html/wg/wiki/AddedElementCanvas" target="_blank" rel="noopener noreferrer">Canvas Element Accessibility Issues</a></li>
</ul>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
...
<ol type="1">
  <li>As a <a href="https://courses.edx.org/assets/courseware/v1/4b7360cab7f3bf439c26782ec47cf7a8/asset-v1:W3Cx+HTML5.1x+2T2020+type@asset+block/Infopgraphic-CanvasCheatSheet-Final2.pdf" target="_blank" rel="noopener noreferrer">PDF file</a>, this canvas cheatsheet:</li>
</ol>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~ 125. snapshot of a canvas cheatsheet from skilled.com (143) ~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image125.webp?raw=true"
  style="width:65%"
  alt="Snapshot of an Canvas cheatsheet from skilled.com." />

<ol start="2" type="1">
  <li>Another resource, as an <a href="https://simon.html5.org/dump/html5-canvas-cheat-sheet.html" target="_blank" rel="noopener noreferrer">HTML file</a>:</li>
</ol>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~ 126. snapshot of a html5 canvas cheatsheet api (144) ~~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image126.webp?raw=true"
  style="width:65%"
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image127.webp?raw=true"
  style="width:55%"
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<p>Small errata about what I said in the above video: “So let’s get the
...
API”..</p>
<p>The part is bold is not correct: querySelector, technically, comes
from <a href="https://www.w3.org/TR/selectors-api/" target="_blank" rel="noopener noreferrer">Selectors API</a>.
Just in case some people would like to check the specification.</p>

<h4>Detailed explanation of the example shown in the above video</h4>

<p>Here are the different steps, in a little more detail, of the example
demonstrated in the above video:</p>
...
<p>Place code similar to the above somewhere in an HTML page. This example defines an area of 300 by 225 pixels on which content can be rendered with JavaScript.</p>
<p>Normally you should see nothing as a result; by default canvases are “transparent”. <b>Make it visible using CSS!</b> For example, you can add a border to the canvas (or change the background color, or put an image in the background).</p>
...
<p>Once we have a pointer to the &lt;canvas&gt;, we can get a “context”. This particular object is the core of the canvas JavaScript API. It provides methods for drawing, like fillRect(x, y, width,
height) for example, that draws a filled rectangle, and properties for setting the color, shadows, gradients, etc.</p>
...
<p>Notice that we wrote an “init” function (<i>line 13</i>) that is called only when the page has been entirely loaded (we say “when the DOM is ready”). There are several ways to do this. In this example we used the &lt;body onload=“init();”&gt; method, at <i>line 29</i>.</p>
<p>It’s good practice to have such a function, as we cannot access the elements of the page before the page has been loaded entirely and before the DOM is ready.</p>
<p>Another way is to put the JavaScript code at the end of the document (between &lt;script&gt;…&lt;/script&gt;), right before the &lt;/body&gt;. In this case when the JavaScript code is executed,
the DOM has already been constructed.</p>
<p><b>Start by getting the canvas and the context:</b></p>
<p>Before drawing or doing anything interesting with the canvas, we must first get its drawing “context”. The drawing context defines the drawing methods and properties we can use.</p>
<p>Good practice is to get the canvas, the context, the width and height of the canvas and other global objects in this “init” function.</p>
<p><b>After the context is set, we can draw, but first let’s set the current color for filled shapes:</b></p>
<p>The example shows the use of the fillStyle property at <i>line 24</i> - useful for specifying the way shapes will be filled. In our case this line indicates the color of all the filled shapes we are going to draw:</p>

<pre>ctx.fillStyle=&#39;#FF0000&#39;;</pre>

<p>The context property named fillStyle is used here. This property can be set with a color, a gradient, or a pattern. We will see examples of these later on in the course.</p>
<p>The example says that all filled shapes will use the color “#FF0000”, which corresponds to a pure red color using the CSS RGB hexadecimal encoding (we could also have used ctx.fillStyle=‘red’);</p>
<p><b>Then we can draw:</b></p>

<pre>ctx.fillRect(0,0,80,100);</pre>

<p>This line is a call to the method fillRect(top left X coordinate, top left Y coordinate, width, height), which draws a filled rectangle.</p>
<p>The way the rectangle will be filled depends on the current value of several properties of the context, in particular the value of the fillStyle property. In our case, the rectangle will be red.</p>
...
<p>Here, we used “stroke” instead of “fill” in the property and method
names (<i>lines 4 and 5</i>): strokeStyle instead
of fillStyle, strokeRect(…) instead of fillRect(…).</p>
<p>We also introduced a new property of the context, that applies only when
drawing in “stroke” mode, the lineWidth property (<i>line 3</i>), that
is used for setting the width of the shape outline. The value is in
pixels.</p>

<h4>Example #2: draw two filled red rectangles with a blue outline of 5 pixels and some text</h4>

<p>Let’s continue with another example. This time we will draw several shapes that share the same colors - they will be filled in red, with a blue outline. We also show how to draw a text message with a given font.
</p>
...
<p>If we draw three rectangles of size 100x200 in a 400x400 canvas, one at (0, 0) and another at (150, 0), and a third at (300, 0), here is the result and the corresponding code:</p>
...
<pre>1.  function drawMonster(x, y) {
2.     // head
...
<p>As you can see, the code uses the same technique, becomes less and
less readable. The Xs and Ys at the beginning of each call makes
understanding the code harder, etc.</p>
<p>However, there is a way to simplify this =&gt; 2D geometric
transformations! </p>
...
the coordinates passed as parameters to each call to drawing methods
...
system.</p>
<p>Let’s take a piece of code that draws something corresponding to the
...
<pre>1.  function drawMonster(x, y, angle, headColor, eyeColor) {
...
<p>As soon as the ctx.strokeRect(x, y, width, height) or the ctx.fillRect(x, y, width, height) method is called, a rectangle is indeed drawn <i>immediately</i> in the canvas.</p>
<p>While drawing rectangles with strokeRect or fillRect, drawing text or drawing images, all these shapes will be drawn in <i>immediate mode</i>.</p>
<p>Another mode called “path mode” or “buffered mode” will be seen later in this course, which will be useful for drawing lines, curves, arcs, and also rectangles. Rectangles are the only shapes that have methods for drawing them <i>immediately</i> and also other methods for drawing them in “<i>path/buffered mode</i>”.</p>
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<p>The canvas API provides two main methods for drawing text: ctx.strokeText(message, x, y) and ctx.fillText(message, x, y). It also provides a set of context properties for setting the character font and style, for laying out the text, etc.</p>
...
<pre>1.  context.font = &quot;60pt Calibri&quot;;
...
7.  // Or
8.  context.strokeText(&quot;Hello World!&quot;, 10, 10);</pre>
...
16. context.strokeText(&quot;Hello World!&quot;, 10, 220, 150);</pre>
...
<h4>JavaScript code extract from this example:</h4>
...
<p>The example above shows the different possible values for this
property and the corresponding results. The default value is
“alphabetic” and corresponds to what has been used in the previous
...
<tr class="even">
  <td>hanging</td>
  <td>The text is aligned based on the line the text seems to hang from.  This is almost identical to top, and in many cases, you cannot see the difference.</td>
</tr>
<tr class="odd">
  <td>middle</td>
...
<tr class="even">
  <td>bottom</td>
  <td>The text is aligned based on the bottom of the glyph in the text, that extends furthest down in the text.</td>
</tr>
</tbody>
</table>
</div>
...
<pre>1.  context.textAlign = &quot;center&quot;;
...
10. context.fillText(&quot;right&quot;, 250, 100);</pre>

</details>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<h3 id="ch3-3-3">3.3.3 Drawing Images</h3>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<p>Working with images is rather simple, except that we need the images
to be fully loaded into memory before drawing them. Loading images is
an <i>asynchronous</i> process we need to take care of. Working with
multiple images might also be difficult for beginners. We present a
multiple image loader later on in this course.</p>
<p><b>Let’s say it once again</b>: To use an image in a canvas, make
sure that the image has been loaded by the Web browser before drawing
it!</p>
<p>It is also possible to draw images from a video stream, images corresponding to another canvas content, or images that are defined by &lt;img&gt; HTML elements in the page. We will see that as well in the following parts of this chapter.</p>
...
<li>We have to create a JavaScript Image object (<i>line 10</i>),</li>
  <li>When we set the src attribute of this object with the URL of the image file, then an asynchronous request is sent in the background by the browser. Loading a big image may take some time, so the rest of the Ja vaScript code continues running. This is why we call it “asynchronous”.</li>
  <li>When the image file has been loaded, the browser calls the onload callback associated with the image (<i>line 14</i>).</li>
  <li>We draw the image only from inside this callback, otherwise we have no guarantee that the image has been loaded and can be usable. The actual drawing here is done <i>line 1</i>.</li>
...
<p>Although you will find many examples on the Web that do it this way, they will only work most of the time with small images, or with images that are in the browser’s cache. Remember that you cannot draw an image that has not been fully loaded!</p>
<p>If you try to draw an image that is not loaded or partially loaded, you will have unexpected results!</p>
...
<p>The <a href="https://www.w3.org/TR/DOM-Level-2-Events/events.html#Events-eventgroupings-htmlevents" target="_blank" rel="noopener noreferrer">DOM
Level 2 Events specification</a> says: “<i>The load event occurs when the DOM implementation finishes loading all content within a document, all frames within a FRAMESET, or an OBJECT element.</i>”</p>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<h3 id="ch3-3-4">3.3.4 Drawing Images from a Video Stream</h3>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<p>The drawImage(…) function can take a video element as its first parameter. The image that will be drawn is the one currently played by the video stream. This can be done at video frequency on most modern computers or mobile devices.</p>
...
<ul>
  <li>In the previous examples, we saw how to draw rectangles using the fillRect(x, y, width, height) and strokeRect(x, y, width, height) methods of the context.</li>
  <li>We also learned how to draw a text message using the fillText(message, x, y) and strokeText(message, x, y) methods that draws a text in filled and wireframe mode, respectively.</li>
</ul>
...
<p>Here is an example that draws 1000 random rectangles in a canvas, using immediate mode rectangle drawing calls:</p>
...
<p><i>Lines 12-18</i> draw 1000 rectangles of random sizes in immediate mode. We also measure the time using the usual console.time(name_of_timer) and console.timeEnd(name_of_timer) that will write in the browser console the time elapsed. Note that console.time(…) and console.timeEnd(…) display results only in the
browser’s console, not in the JSBin console.</p>
<p>On a Mac Book Pro from 2015, the result is an average time of 4.034ms for drawing all these rectangles:</p>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
...
<ol type="1">
  <li>Call drawing methods that work in path mode, for example call ctx.rect(…) instead of ctx.strokeRect(…) or ctx.fillRect(…),</li>
  <li>Call ctx.stroke() or ctx.fill() to draw the buffer’s contents,</li>
  <li>Beware that the buffer is never emptied, two consecutive calls to ctx.stroke() will draw the buffer contents twice! Instead, use ctx.beginPath() to empty it if needed,</li>
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<p><b>Warning</b>: you do not need to spend too much time on each part
of this sub-section.</p>
<p>You do not need to memorize or learn by heart all the examples in the
following pages. They are given as references. There will be no quizzes
about curves as they are not often done “by hand”, but are generated by
tools such as Adobe Illustrator or online generators.</p>

<ul>
  <li>You need to draw arcs? Then, please use the corresponding section as a reference: you know you will find one or more examples and a detailed explanation.</li>
  <li>You need to draw lines? Arrows? Curves? Same thing: go to the corresponding pages and look at the examples!</li>
</ul>
...
<p>Now let’s go a bit further by introducing the notion of “path
drawing”. This approach uses the ctx.moveTo(x, y) method of the context,
in conjunction with other drawing methods that end in “To”, such
as ctx.lineTo(x, y).</p>
<p>This makes it easier to draw multiple connected lines. Consecutive
calls to ctx.lineTo(x, y) will store in the path/buffer a set of
connected lines that we will draw altogether by a single call
to ctx.stroke() or ctx.fill().</p>

<h4>Here are the 5 different steps:</h4>

<ol type="1">
  <li>Put the “pencil” somewhere with a call to ctx.moveTo(x1, y1). This will be the origin of the first line.</li>
  <li>Call the ctx.lineTo(x2, y2) method to draw a line from the previous position (previous step) to the position passed as parameters to the lineTo(…) method. This position will serve as the origin for the next line to be drawn.</li>
  <li>Call lineTo(x3, y3) again to draw a line that goes from (x2, y2) to (x3, y3). This line will start at the end of the previous one.</li>
  <li>Repeat step 3 to draw more connected lines.</li>
  <li>Call the ctx.stroke() or the ctx.fill() methods to draw the path defined by the different lines.</li>
</ol>

<p>Note the call to ctx.stroke() or ctx.fill() will use the current
values of the strokeStyle or fillStyle properties. It is possible to
call ctx.moveTo(x, y) in the middle of steps 1 through 5 in order to
move the pen somewhere else without connecting to the last drawn
line.</p>
...
<pre>1.  var canvas=document.getElementById(&#39;myCanvas&#39;);
...
<p>In this example, the entire grid is drawn during the execution of the last line of code, with the single call to ctx.stroke().</p>
...
<p>This example shows that filled and wireframe shapes should be drawn differently (here a filled rectangle is drawn using a call to the fillRect(…) method while a wireframe set of connected lines is drawn using the stroke() method of the context).</p>
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image140.webp?raw=true"
...
<ol type="1">
  <li>The call to stroke() has drawn the path corresponding to the <i>lines 5-7</i>. Indeed, the first part of the path (on the left) has actually been drawn once in wireframe mode, and in blue.</li>
  <li>Then, the call to fill() at <i>line 20</i> has drawn the whole path again, but in pink and in filled mode. But this time the path corresponds to <i>lines 5-7</i> plus <i>lines 14-16</i> that make up the second shape on the right. <i>So the path that has been drawn this time is made of both of the triangles.</i></li>
</ol>
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image141.webp?raw=true"
...
<pre>1.  function drawLine(x1, y1, x2, y2, color, width) {
2.      ctx.save();
3.  
...
<pre>1.  // Adapted from : https://stackoverflow.com/questions/808826/draw-arrow-on-canvas-tag
...
<p>This <a href="http://www.dbp-consulting.com/tutorials/canvas/CanvasArrow.html" target="_blank" rel="noopener noreferrer">article
on drawing lines and arcs with arrow heads</a> is worth reading. It
details how to draw arrows with curved heads and different styles for
the head. Note, however, that you will need to modify some parts if you
want it to support different line widths, etc.</p>
...
<ul>
  <li><i>Lines 5-7</i> corresponds to a path made of two consecutive lines. If we just call stroke() after that, two lines will be drawn on the canvas.</li>
  <li><i>Line 10</i> indicates that we would like <i>a closed path</i>.  In this case, the call to stroke() at <i>line 14</i> will draw the two lines plus an extra line that connects the last point of the path to the first one. It will draw a closed triangle!</li>
</ul>
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<p>The ctx.arc(cx, cy, radius, startAngle, endAngle, drawInverse) method
is useful for drawing arcs of circles. It takes the center of the
...
<p><i>Note</i>: the figures in this page have been borrowed from
the <a href="https://www.html5canvastutorials.com/tutorials/html5-canvas-arcs/" target="_blank" rel="noopener noreferrer">HTML5
...
<pre>1.  ctx.arc(centerX, centerY, radius, startAngle, endAngle); // clockwise drawing
2.  
3.  ctx.arc(centerX, centerY, radius, startAngle, endAngle, false);</pre>
...
<h4>Project #1: modify the <a href="https://codepen.io/w3devcampus/pen/YzZBxmO" target="_blank" rel="noopener noreferrer">previous example</a> in order to get:</h4>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 150. half circle (208) ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
...
<pre>1.  ctx.moveTo(x0, y0);
2.  
3.  ctx.arcTo(x1, y1, x2, y2, radius);</pre>
...
<pre>1.  Draw an imaginary line through (x0,y0) and (x1,y1), draw another imaginary line through (x1,y1) and (x2,y2),
...
5.  Finally, it adds the tangent point where the arc ends up, on the line from (x1,y1) to (x2,y2) to the path as the new current point on the path.</pre>
...
<pre>1.   var roundedRect=function(ctx,x,y,width,height,radius,fill,stroke) {
2.      ctx.beginPath();
3.  
...
28.  ctx.lineWidth   = 7;
29. 
30.  roundedRect(ctx, 15, 15, 160, 120, 20, true, true);</pre>
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image155.webp?raw=true"
...
5.  ctx.arcTo(x, y, x+width, y,radius);</pre>
...
5.  ctx.arcTo(x, y, x+radius, y,radius);</pre>
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image156.webp?raw=true"
...
<pre>1.  context.moveTo(contextX, contextY);
...
<pre>1.  var canvas=document.querySelector(&#39;#myCanvas1&#39;);
...
<pre>1. var canvas = document.querySelector(&#39;#myCanvas&#39;);
2. var ctx = canvas.getContext(&#39;2d&#39;);
3. var contextX = 100;
4. var contextY = 10;
5. var endPointX = 200;
...
<pre>1.  function drawCurvedArrow(startPointX, startPointY,
...
<p>(Picture taken from the <a
href="https://www.html5canvastutorials.com/tutorials/html5-canvas-bezier-curves/" target="_blank" rel="noopener noreferrer">HTML5 Canvas Tutorials</a> Web site)</p>
<p>The best way to understand how they work is to check out one of these
interactive applications:</p>

<ul>
  <li><a href="https://blogs.sitepointstatic.com/examples/tech/canvas-curves/bezier-curve.html" target="_blank" rel="noopener noreferrer">Canvas Bézier Curve Example</a></li>
  <li><a href="http://lib.ivank.net/?p=demos&amp;d=bezier" target="_blank" rel="noopener noreferrer">IvanK Lib graphics demos</a></li>
  <li>Nice video tutorial: <a href="https://vimeo.com/106757336" target="_blank" rel="noopener noreferrer">Bézier curves under the hood</a></li>
</ul>
...
<pre>1.  ctx.moveTo(contextX, contextY);
...
<p>You can use <a href="https://www.w3.org/TR/css3-color/" target="_blank" rel="noopener noreferrer">the same syntax 
  for colors that is supported by CSS3</a>. The next lines show possible values/syntaxes.</p>

<pre>1. ctx.strokeStyle = &#39;red&#39;;
2. ctx.fillStyle = &quot;#00ff00&quot;;
3. ctx.strokeStyle = &quot;rgb(0, 0, 255)&quot;;
4. ctx.fillStyle = &quot;rgba(0, 0, 255, 0.5)&quot;;</pre>

<p>Note that:</p>

<ul>
  <li>All values are strings;</li>
  <li><i>Line 4</i> defines a “transparent color”, the “a” of “rgba” means “alpha channel”. Its value is between 0 and 1, where 0 means “completely transparent” and 1 means “opaque”.</li>
</ul>

<h4>Here is an example that shows how to draw different filled rectangles in blue, with different levels of transparency:</h4>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<p>It is possible to define the stroke or the fill style as a “gradient”, a set of interpolated colors, like in this example below:</p>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
...
<pre>1.  var canvas, ctx, grdFrenchFlag;
2.  function init() {
...
<p>The result is shown in the <a href="https://codepen.io/w3devcampus/pen/WNpPZVO" target="_blank" rel="noopener noreferrer">
  above pen</a>: a big rectangle that fills the whole canvas, with colors going from blue (left) to white (middle) to red (right).</p>

<h4>Examples</h4>

<h4>Example #1: changing the direction of the gradient</h4>

<p>If you modify the source code that defines the direction of the
...
<pre>1.  ctx.fillStyle = grdFrenchFlag;
...
13. ctx.fillRect(250, 150, 50, 50);</pre>
...
<pre>1. // n = number of cells per row/column
...
<pre>1.  function drawCheckboard(n) {
...
28.       ctx.fillRect(x, y, cellWidth, cellHeight);</pre>
...
<pre>1. function setGradient(x, y, width, height) {
...
<pre>1. var grd = context.createRadialGradient(150, 100, 30, 150, 100, 100);
...
<p>We added color stops using a method similar to that used for linear
gradients.</p>

<h4>What happens if the circles are not located at the same place?</h4>

<p>You get some nice effects; here we set the second
circle’s center 60 pixels to the right of the first circle’s center (cx
= 210 instead of 150):</p>
...
<ol start="2" type="1">
  <li><b>Define a callback function that will be called once the image has been fully loaded</b> in memory; we cannot draw before the image has been loaded.</li>
</ol>
...
<ol start="5" type="1">
  <li><b>Inside the callback function (or inside a function called from inside the callback), we can finally draw</b>:</li>
</ol>

<pre>1. // callback called asynchronously, after the src attribute of imageObj is set
...
<pre>1.  pattern1 = ctx.createPattern(imageObj, &quot;repeat&quot;);</pre>
...
<pre>1.  // List of images to load, we used a JavaScript object instead of
...
<pre>1.  function loadImages(imagesToBeLoaded, drawCallback) {
2.       var imagesLoaded = {};
...
<pre>1.  loadImages(imagesToLoad, function(imagesLoaded) {
...
<pre>1.  function drawRectanglesWithPatterns() {
...
<p>Let’s take a <a href="https://codepen.io/w3devcampus/pen/YzZBxmO" target="_blank" rel="noopener noreferrer">previous example</a>, the one that draws a filled circle with an outline. And, let’s add a shadow to it using the following code:</p>
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<h3 id="ch4-1-1">4.1.1 Animations - An Introduction – Module 4</h3>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
...
<p>Even before HTML5 and the introduction of the canvas element, people created HTML games. They used CSS backgrounds inside &lt;div&gt; elements, and used to change the CSS top, left, width and height properties of the divs to animate graphic images on the screen.</p>
<p>During the late 1990s and early 2000s, JavaScript became increasingly popular. The community created a first ‘umbrella term’ describing a collection of technologies used together to create interactive and animated Web sites - <a href="https://en.wikipedia.org/wiki/Dynamic_HTML" target="_blank" rel="noopener noreferrer">DHTML (Dynamic HTML)</a>. For example, check the <a href="https://def-logic.com/" target="_blank" rel="noopener noreferrer">games developed at this time by Brent Silby</a> (they all use DHTML).</p>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
...
<p>This function is certainly more suitable for doing graphic animation, such as for writing an HTML5 game. It will never interrupt an ongoing
animation, even if the instructions inside the animation loop take too long.</p>

<h4>Problems with setInterval() and setTimeout()</h4>
<p>setTimeout does not “wait”  during the timeout period. It lets the rest of the JavaScript code run. It schedules a new call to the function passed as first parameter with a timer running in the background. This might cause it to take slightly longer than the expected timeout period to start executing.</p>
<p>This problem also occurs with setInterval, the timing is not “very” reliable. If you plan to run a function every 20ms, and if you measure precisely the real timing, sometimes you will discover big differences between what is scheduled and what is performed. This is because these methods were designed a long time ago, when high precision timers and 60 frames per second animation were not an option.</p>
<p>Here comes the <a href="https://www.w3.org/TR/html51/webappapis.html#animation-frames" target="_blank" rel="noopener noreferrer">requestAnimationFrame API,</a> a very good companion to the canvas API!</p>
...
<p>You will note that  requestAnimationFrame(function) is used
...
with cancelAnimationFrame(id).</p>
...
<pre>1.  function animationLoop(timeStamp) {
2.    // 1 - Clear
3.    ctx.clearRect(0, 0, canvas.width, canvas.height);
4.   
5.    // 2 - Draw
...
<p>Notice that calling requestAnimationFrame(animationLoop) at <i>line 19</i>, and after that from within the loop at line 14, asks the browser to call the animationLoop function so that the delta between calls will be as close as possible to 16.6ms  (this corresponds to 1/60th of a second).</p>
...
<p>Many HTML5 games perform what we call a “time-based animation”. For
this, we need an accurate timer that will tell us the elapsed time
between each animation frame.</p>
<p>Depending on this time, we can compute the distances that must be
...
<p>The timeStamp parameter of the animationLoop function (<i>line
1</i> in the above code) is useful for exactly that: it gives a high
resolution time. By measuring deltas between two consecutive calls of
the animationLoop, we will know exactly, with a sub-millisecond
accuracy, the elapsed time between two frames.</p>
<p>Using time-based animation, and more generally, using the canvas
element for writing HTML5 games, is part of the W3Cx HTML5 Apps and
Games course.</p>
<p>Current <a href="https://caniuse.com/requestanimationframe" target="_blank" rel="noopener noreferrer">support</a> is
really good and all modern browsers support this API.</p>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
...
<pre>1.  &lt;div id=&quot;someDiv&quot; onclick=&quot;alert(&#39;clicked!&#39;);&quot;&gt;
...
<pre>1.  document.getElementById(&#39;someDiv&#39;).onclick = function(evt) {
2.    alert(&#39;clicked!&#39;);
3.  }</pre>
...
<pre>1.  document.getElementById(&#39;someDiv&#39;).addEventListener(&#39;click&#39;, function(evt) {
2.      alert(&#39;clicked!&#39;);
3.  }, false);</pre>
...
<pre>1. &lt;canvas id=&quot;myCanvas&quot; width=&quot;350&quot; height=&quot;200&quot;&gt;
2. &lt;/canvas&gt;
3. &lt;script&gt;
4. var canvas;
5. function init() {
...
<pre>1.  &lt;canvas id=&quot;myCanvas&quot; width=&quot;350&quot; tabindex=&quot;1&quot; height=&quot;200&quot;&gt;
2.  &lt;/canvas&gt;</pre>

<h4>And we force the canvas to get the focus with:</h4>

<pre>1.  canvas=document.getElementById(&#39;myCanvas&#39;);
2.    ...
3.  canvas.focus();</pre>
...
<p>Note that the line that forces the focus to the canvas is commented
by default. Try to click on the canvas, then press a key, then click out
of the canvas, then press a key: this time nothing happens!</p>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
...
<pre>1.  canvas.addEventListener(&#39;mousedown&#39;, function (evt) {
...
<ul>
  <li>mouseleave: similar to mouseout, fired when the mouse leaves the surface of the element. The difference between mouseleave and mouseout is that mouseleave does not fire when the cursor moves over descendant elements, and mouseout is fired when the element moved is outside of the bounds of the original element or is a child of the original element.</li>
  <li>mouseover: the mouse cursor is moving over the element that listens to that event. A mouseover event occurs on an element when you are over it - coming from either its child OR parent element, but a mouseenter event only occurs when the mouse moves from the parent element to the child element.</li>
  ...
  <li>mousemove: fired while the mouse moves over the element. Each time the mouse moves, a new event is fired, unlike with mouseover or mouseenter, where only one event is fired.</li>
</ul>
...
<pre>1. function getMousePos(canvas, evt) {
...
<pre>1.  var canvas, ctx, mousePos, mouseButton;
2.   
...
<p>This example shows an animation at 60 frames/s
...
around its center. If we release the mouse button, the rotation
stops:</p>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
...
<pre>1.  function handleMouseMove(evt) {
...
monster’s size. We scale down the monster (using ctx.scale!)</p>
<p>The code is very similar to the previous example, we just
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<p>The canvas API is a “big beast”, and we have presented all the essential techniques for drawing and animating. However, we could not fit everything in this course. Exotic features that are rarely used by developers, or advanced techniques that require more than 20 lines of
JavaScript, have been put aside for <a href="https://www.edx.org/course/html5-apps-and-games" target="_blank" rel="noopener noreferrer">the W3Cx HTML5 Apps and Games course</a>.</p>
<p>In that course, you will learn:</p>

<ul>
  <li>Techniques useful for writing HTML5 games: time-based animation, advanced user interactions (detecting multiple keys plus mouse plus gamepad plus touch events all at the same time in a  single version of the code), sprite based animation, collision detection, particle animation;<br></li>
  <li>Pixel-level operations: special FX like blue-screen videos and augmented reality;<br></li>
  <li>And many other things, such as: masking/clipping, stacking canvases in layers, composition modes, saving and restoring canvas contents, saving canvas content to disk client-side, drawing a canvas into a canvas, etc.<br></li>
</ul>

<h4>Examples studied in the HTML5 Apps and Games course</h4>

<ul>
  <li>Small game framework / object oriented JavaScript / advanced event handling / collision detection / time based animation - see <a href="https://jsbin.com/jifutoj/1/edit?html,js,console,output" target="_blank" rel="noopener noreferrer">example online</a>.<br></li>
  <li>Sprite based animation: like this <a href="https://jsbin.com/libakum/1/edit?html,js,console,output" target="_blank" rel="noopener noreferrer">one</a> (this is ugly code to demonstrate the principle - in the course we develop a clean, sprite animation framework). Use the arrow keys after clicking in the canvas. It’s better to try in standalone mode (click on the small black arrow in the top right of the JSBin window).</li>
</ul>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
...
<img class="displayed"
  ...
  style="width:35%;" />
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<h3 id="ch5-1-1">5.1.1 HTM5 Forms Introduction - Module 5</h3>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<p>Congratulations! You made it to module 5.</p>
<p>Welcome this time to the wonderful world of HTML5 forms.</p>
<p>There have been no improvements since 1997 to HTML forms.</p>
<p>HTML5 this time comes with a set of new input fields for entering
dates, colors, entering phone numbers, URLs, and so on.</p>
<p>New attributes related to form validation have also been introduced,
and they are related to a new build-in validation system that make
things easier than before without the need to use JavaScript.</p>
<p>However, JavaScript validation API is also available for people who
would like to write their own customized validation system.</p>
<p>These additions are very handy when used on mobile devices but raised
...
<ul>
  ...
  <li>Built-in validation system: JavaScript API for custom validation, CSS pseudo classes that are useful for changing an input field style depending on the validity of the input.<br></li>
  <li>Other goodies, such as the option to set an input field out of a &lt;form&gt;, new elements such as &lt;datalist&gt; for autocompletion, &lt;output&gt; for feedback, etc.<br></li>
</ul>
...
<ul>
  <li>From the specification: <a href="https://html.spec.whatwg.org/multipage/forms.html" target="_blank" rel="noopener noreferrer">Forms</a></li>
  <li>From MDN’s Web Docs: <a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Element/form" target="_blank" rel="noopener noreferrer">&lt;form&gt;</a></li>
</ul>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
...
<p>Feel free to look at the source code in the <a href="https://jsbin.com/sivula/edit?online%20example/" target="_blank" rel="noopener noreferrer"></a>:</p>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image215b.webp?raw=true"
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image215c.webp?raw=true"
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image215d.webp?raw=true"
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image216a.webp?raw=true"
...
<pre>1.  &lt;label for=&quot;first_name&quot;&gt;Your First Name&lt;/label&gt;
2.  &lt;input id=&quot;first_name&quot; type=&quot;text&quot; name=&quot;fname&quot;/&gt;</pre>
...
4. &lt;input type=&quot;button&quot; value=&quot;Cancel&quot;&gt;</pre>
...
invite you to see an example provided in the <a
href="https://www.w3.org/WAI/tutorials/forms/grouping/#associating-related-controls-with-wai-aria" target="_blank" rel="noopener noreferrer">associated
WAI tutorial</a>. See also this MDN’s article about about <a
href="https://developer.mozilla.org/en-US/docs/Web/Accessibility/ARIA/Roles" target="_blank" rel="noopener noreferrer">WAI-ARIA
roles</a>.</p>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<h3 id="ch5-4-1">5.4.1 Input Types</h3>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<p>In this section, we briefly present the input types, attributes, and
elements related to the forms that came with HTML5. Details are given
later, illustrated by multiple interactive examples.</p>
<p>Compared to HTML4, HTML5 introduced 13 new input types, covering most
of the needs of  Web developers. HTML5 packages some of the “form best
...
JavaScript embedded in complex Web pages.</p>
<p>MDN’s Web docs <a
href="https://developer.mozilla.org/en-US/docs/Web/HTML/Element/input#%3Cinput%3E_types" target="_blank" rel="noopener noreferrer">article
on &lt;input&gt; types</a> lists all input types and highlights those
that came with HTML5.</p>
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<p>For years, we used hundreds of lines of JavaScript for selecting
colors. Now, it’s bundled in the browser!</p>
...
<i>Note</i>: In this chapter we are simplifying the examples, as we
usually embed input elements in a &lt;form&gt;…&lt;/form&gt;.
<p>Try &lt;input type=“color”&gt; online with this
<a href="https://jsbin.com/cajuzob/1/edit?html,output" target="_blank" rel="noopener noreferrer">JSBin
example</a>. Or do it here in your browser: just click on the purple square below:</p>
<p>Here is the result on Google Chrome (works with other browsers too,
though the <i>look and feel</i> may differ):</p>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
...
<p>The &lt;input type=“color”&gt; can fire change or input events. Here
is an example that changes the background color of the page when a color
is chosen. <a
href="https://jsbin.com/jozuter/1/edit?html,css,js,console,output" target="_blank" rel="noopener noreferrer">Try it online at JSBin</a>.</p>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
...
<p>By default, the color selector offers many options that may either
frighten some users or just not be appropriate for the purpose of the
application. </p>
<p><i>Good news</i>: it is possible to restrict the choices, and also
simplify the user interface, by using a &lt;datalist&gt; with
some &lt;option&gt; elements inside.</p>
<p>Example: click the black rectangle on the right:  . The following
...
<p><a href="https://jsbin.com/lahapu/edit?html,output" target="_blank" rel="noopener noreferrer">Online example at JSBin</a></p>
...
<p>Note that the id of the &lt;datalist&gt; element should be the same
as the value of the list attribute of the input field.</p>
<h4>What are the main problems with this element?</h4>
<p>The main criticism that Web designers make about this element is
related to its default appearance being strongly dependent on the
browser and its underlying operating system. Changing the <i>look and
feel</i> is not possible, except with the use of the options we saw in
the previous sections of this page. This problem is also true for other
input elements that renders as complex widgets, like &lt;input
type=“date”&gt; and its variants.</p>
<p>Another problem is that there is no way to control where the dialog
that contains the color chooser will appear - no positioning via CSS or
...
specific.</p>
<p>The solution proposed by the W3C and its contributors is
called <i>Web Components</i>, a new approach for designing HTML5
widgets, that is covered in the W3Cx HTML5 Apps and Games course.</p>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<h3 id="ch5-4-3">5.4.3 “date”</h3>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<p>For years, date and time pickers in HTML forms made Web developers
rely heavily on JavaScript based widgets. The process is simpler in
HTML5, which provides a special control to handle this specific kind of
data natively.</p>
<p>Below are a few screenshots of the HTML5 date picker on several
mobile devices. Note that the native date pickers of the operating
systems are used:</p>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
...
<p>The problem is different on a desktop. While it’s great to have
native support for a date picker, Web developers would sometimes
prefer 100% control over the <i>look and feel</i> of the date picker
widget. For this purpose, the solution undoubtedly lies with the new <a
href="https://webcomponents.org/" target="_blank" rel="noopener noreferrer">Web Components</a> (a way to make custom reusable widgets in HTML/CSS/JS), to be detailed in the W3Cx HTML5 Apps and Games course</p>
...
<p>Typical use:
<a href="https://codepen.io/w3devcampus/pen/aWXKWR" target="_blank" rel="noopener noreferrer">Online example at CodePen</a></p>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~~ 248. other mobile keyboard for input type=tel (xxx) ~~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
...
<p>This input type is often used with the new placeholder and pattern attributes that are detailed in
another section of this course. It is supported by all recent major Web browsers, on mobile devices and desktops.</p>
<p><a href="https://codepen.io/w3devcampus/pen/Njozvd" target="_blank" rel="noopener noreferrer">Online example on CodePen</a></p>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~~~~~~~ 249. enter a telephone number prompt (xxx) ~~~~~~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
...
<p>Try it in your browser (we used the same CSS for changing the background-color when the input value is invalid):</p>
...
URLs:</p>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~~~~~~ 250. mobile keyboard for entering urls (xxx) ~~~~~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
...
<p>Here is an online example that shows the use of the placeholder and pattern attributes for entering only URLs that start with ftp:// or https://</p>
<p>Or try it here in your browser:</p>
<p>Enter a URL (default validation): </p>
<p>Enter a URL (custom validation, must start with http, https or ftp): </p>
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~ 251. input type=search rendered on a smartphone (xxx) ~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
...
<p>Examples on desktop (the width will be adjusted depending on
the min and max attributes):</p>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
...
<p><a href="https://codepen.io/w3devcampus/pen/GJrQzP):" target="_blank" rel="noopener noreferrer">Online example
in CodePen</a> try changing the attribute values, use step=“any” and try
float values, etc).</p>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~ 257. change attribute values (317) ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~~~~~~~~ 258. using zipper as range setting (318) ~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~~~~~~~ 259. play with attributes on desktop (318) ~~~~~~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~~~~~~~ 260. on left range, default, vertical (318) ~~~~~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 261. on right range android (318) ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
...
<h4><a href="https://codepen.io/w3devcampus/pen/BRMVGW" target="_blank" rel="noopener noreferrer">This online example on CodePen</a> shows how to add a visual feedback using a very short JavaScript function and an &lt;output&gt; element. Just click and drag the small cursor of the slider (or use up and down arrow keys when the field has the focus):</h4>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~~~ 262. add visual feedback with short function (319) ~~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
...
<pre>1.  &lt;label for=&quot;slider2&quot;&gt;value=5 min=0, max=10 step=1, ticks at 2, 4, 6, 8 and 10:&lt;/label&gt;
...
<ul>
  <li>You can use CSS for “standard” styling (size, color, background color, etc.) . However, some custom attributes are available. Check <a href="https://css-tricks.com/styling-cross-browser-compatible-range-inputs-css/" target="_blank" rel="noopener noreferrer">this article from CSS tricks</a>.</li>
  <li>A script that automatically generates ticks, depending on the min, max and step attributes (Codepen from Dudley Storey): <a href="https://codepen.io/dudleystorey/pen/Klnzy" target="_blank" rel="noopener noreferrer">Auto-Generated HTML5 range input Ticks</a></li>
  <li>From CSS{Portal}, a CSS generator help you style the html input range tag, very easy to use: <a href="https://www.cssportal.com/style-input-range/" target="_blank" rel="noopener noreferrer">Style Input Range</a></li>
</ul>
...
<tr class="odd">
<td>*  pseudoclasses CSS target with :disabled and :checked
or :required selectors</td>
<td></td>
</tr>
<tr class="even">
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image265.webp?raw=true"
  style="width:25%;"
...
<p><a href="http://codepen.io/w3devcampus/pen/jmdpyv)" target="_blank" rel="noopener noreferrer">Try this interactive example in CodePen</a>, or try it directly in your browser:</p>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
...
<p><i>Lines 12</i> and <i>22</i> shows the form attribute. Make sure that its value matches the id of the form!</p>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<h3 id="5-5-3">5.5.3 autocomplete</h3>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<p>This attribute applies either to the &lt;form&gt; element or on individual &lt;input&gt; elements. It specifies when input fields must autocomplete the user’s input based on the user’s typing history. </p>
<p>Possible values of this attribute: on/off.</p>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~ 267. bright red on off picture (322) ~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image267.webp?raw=true"
  style="width:16%;"
  alt="On/off funny picture." />

<p>If applied to the &lt;form&gt; element, all input fields attached to the form (inside or linked to it using the form attribute), will have auto-completion set by default to the value of the autocomplete attribute of the form.</p>
<p>This default behavior can be overridden by setting it individually to any input field inside. In other words: it is possible to have autocomplete “on” for the form, and “off” for specific input fields, or vice-versa.</p>
<p>Sometimes this autocomplete behavior is disabled by default in some Web browsers, and will need to be adjusted in the preferences/settings. </p>
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image268.webp?raw=true"
  style="width:40%;"
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image268b.webp?raw=true"
  style="width:40%;"
...
<pre>1.  &lt;form submit=&quot;test.php&quot; method=&quot;post&quot; autocomplete=&quot;on&quot;&gt;
2.    ...
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image269.webp?raw=true"
  style="width:65%;"
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<p>This attribute works together with the new &lt;datalist&gt; element we already studied when we saw the color and date input fields.</p>
<p>This attribute’s value must match the id of a &lt;datalist&gt; element. It is useful for providing local auto-completion to some input fields, or for restricting the possible values on some others like &lt;input type=date&gt; or &lt;input type=color&gt;.</p>
<p>Here is a small code extract from a more complete example shown in the section about the new &lt;datalist&gt; element (see next unit).</p>
<p>Please try it in your  browser (Type “F”, “E”, “O”, C” etc., or just click inside the field and use the drop down menu). Note that you can also enter any value; if it does not start with one of these letters it will be accepted but will not trigger auto-completion.</p>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~~~~~~ 270. preferred browser and submit query (325) ~~~~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image270.webp?raw=true"
  style="width:65%;"
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image271.webp?raw=true"
  style="width:65%;"
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image271c.webp?raw=true"
  style="width:65%;"
...
<pre>1.  &lt;input type=&quot;text&quot; name=&quot;country_code&quot;
2.         pattern=&quot;[A-Za-z]{3}&quot;
...
<p>Try
this <a href="https://jsbin.com/xeyuqux/1/edit?html,output" target="_blank" rel="noopener noreferrer">online
example at JSBin</a> or directly in your browser below:</p>
<!--
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image271b.webp?raw=true"
  style="width:65%;"
...
<p>Try this <a href="https://jsbin.com/bozudeg/1/edit?html,output" target="_blank" rel="noopener noreferrer">example online</a> or in your browser below:</p>
<p>Attributes used: placeholder (for displaying a ghost example value), pattern, required (empty field = invalid)…</p>
...
<p><a href="https://jsbin.com/nulahey/1/edit?html,output)or" target="_blank" rel="noopener noreferrer">Online example at JSBin</a> try it in your browser:</p>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
...
<pre>1.  &lt;input id=&quot;mydate&quot; name=&quot;mydate&quot;
2.    type=&quot;date&quot;
3.    min=&quot;2012-01-01&quot;
4.    max=&quot;2013-01-01&quot;
5.    value=&quot;2012-01-01&quot;
...
<pre>1. &lt;input type=&quot;submit&quot;
2. formaction=&quot;preview.php&quot; formmethod=&quot;get&quot; value=&quot;Preview&quot;&gt;</pre>
...
<pre>1. &lt;form action=&quot;post.php&quot; method=&quot;post&quot;&gt;
2.   &lt;input type=&quot;submit&quot;
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image272.webp?raw=true"
  style="width:40%;"
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image273.webp?raw=true"
  style="width:40%;"
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image275a.webp?raw=true"
...
<pre>1. &lt;input type=&quot;submit&quot;
2.   formtarget=&quot;_blank&quot;
3.   value=&quot;Submit but show results in a new window/tab&quot;&gt;</pre>
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image276a.webp?raw=true"
  alt="Example of formtarget attribute."
  style="width:40%;" />

<h4>Source code:</h4>

<pre>1.  &lt;form action=&quot;defaultAction.php&quot;&gt;
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image276.webp?raw=true"
...
<p>If you run <a
href="https://jsbin.com/lokukam/4/edit?html,output" target="_blank" rel="noopener noreferrer">this example in the
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image277.webp?raw=true"
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image278.webp?raw=true"
  alt="blank blank."
  style="width:50%;" />
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image279.webp?raw=true"
  alt="Example of output element use."
  style="width:35%;" />

<p>Typical use / interactive examples</p>
<p><a href="https://jsbin.com/yuvani/1/edit?html,output" target="_blank" rel="noopener noreferrer">Do not hesitate
to play with the source code of these examples online at JSBin</a>.</p>

<h4>Example #1</h4>

<pre>1. &lt;form oninput=&quot;o.value=a.valueb.value&quot;&gt;
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image280.webp?raw=true"
...
<pre>1.  &lt;p&gt;Grades: &lt;meter id=&quot;meter2&quot; value=&quot;75&quot; min=&quot;0&quot; low=&quot;20&quot; high=&quot;80&quot; max=&quot;100&quot;&gt;&lt;/meter&gt;
2.  
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image281.webp?raw=true"
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image282.webp?raw=true"
  alt="Picture of the funny progress meme saying Every mistake you make is progress."
  style="width:10%;" />

<p>Gives:</p>
<p>The browser calculates the percentage corresponding to
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image283.webp?raw=true"
  alt="Indetermined progress bar screenshot."
  style="width:50%;" />

<h4>Typical use:</h4>

<p><a href="https://jsbin.com/hebiju/edit?html,output" target="_blank" rel="noopener noreferrer">Here is an online example at JSBin</a>, or try it below in your browser:  </p>
...
<pre>1.  Download progress: &lt;progress id=pr value=100 min=0 max=1000&gt;&lt;/progress&gt;
2.  &lt;script&gt;
3.     var i=0;
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image284.webp?raw=true"
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image285.webp?raw=true"
  alt="Another example input field choices with lookahead."
  style="width:30%;" />

<p>We have already seen this element in action with
different &lt;input&gt; elements, such as &lt;input
type=“color”&gt;, &lt;input type=“date”&gt;, or &lt;input
type=“range”&gt;.</p>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image286.webp?raw=true"
  alt="Restrict choices using a datalist element."
  style="width:60%;" />
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image287.webp?raw=true"
...
<p>Here is an <a
href="https://jsbin.com/tiqexel/1/edit?html,output" target="_blank" rel="noopener noreferrer">online example at
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image288.webp?raw=true"
...
<pre>1.  &lt;form action=&quot;demo_form.asp&quot; method=&quot;get&quot;&gt;
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image289.webp?raw=true"
  alt="Bubble message example."
  style="width:35%;" />

<p>The default bubble message and visual feedback differ from one implementation to another, but they may be customized, with some limitations that will be explained later.</p>
<p>For example, browsers may provides default feedback on the input field’s border (red = invalid, green = ok). This default behavior can be overridden by CSS rules as illustrated in the section about new input type attributes.</p>
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image288b.webp?raw=true"
...
<p>Example #2: add CSS transitions + an icon/marker to the right of the
input fields</p>
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image289b.webp?raw=true"
...
<p>Try the <a href="https://jsbin.com/locedoy/1/edit?html,output" target="_blank" rel="noopener noreferrer">online
example at JSBin</a>, or try it here in your browser (type invalid
values and look at the custom messages):</p>
<p>Top of Form</p>
...
<p>Google Chrome on a French desktop computer:</p>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~ 290. chrome shows native error msg and localized (347) ~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image290.webp?raw=true"
  alt="Chrome shows native error message localized and the title attribute content as is."
  style="width:65%;" />

<p>Same example on FireFox, the title attribute is ignored:</p>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~ 291. firefox title attribute (347) ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image291.webp?raw=true"
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image292b.webp?raw=true"
  alt="JavaScript form validation API."
  style="width:65%;" />

<h4>Typical use</h4>

<p>Be careful when you try this example in JS Bin standalone mode (click the small black arrow on the top right of the output tab).</p>
<p>Or, you may try it <a href="https://jsbin.com/nalaxeg/1/edit?html,output" target="_blank" rel="noopener noreferrer">here</a> in your browser.</p>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~~~~~~~ 292c. example use of validation api (347) ~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image292c.webp?raw=true"
...
validation error.</p>
<p>Here is how to get the validity property of an input field:</p>

<pre>1. var input = document.getElementById(&#39;IdOfField&#39;);
2.  
3. var validityState_object = &lt;b&gt;input.validity;&lt;/b&gt;</pre>
...
<p>Here is <a href="https://jsbin.com/nalaxeg/1/edit?html,output" target="_blank" rel="noopener noreferrer">an
example at JSBin that shows how to test the different types of
validation errors</a>, or you may try it here in your browser (enter bad
values, too big, too small, enter invalid characters, etc.):</p>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~~~~~~~~ 292. enter value between 10 and 20 (349) ~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image292.webp?raw=true"
...
<pre>1. var input = document.getElementById(b);
2.   
3. console.log(&quot;Validation message = &quot; + input.validationMessage);</pre>
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image293.webp?raw=true"
...
<p>Here is <a
href="https://www.telerik.com/blogs/building-html5-form-validation-bubble-replacements" target="_blank" rel="noopener noreferrer">an
adaptation of work presented at the developer.telerik.com Web site</a>.
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image294.webp?raw=true"
...
<ul>
  <li><i>Line 32</i>: we added an empty unnumbered list (&lt;ul&gt;…&lt;/ul&gt;) to the form, with the CSS class=“error-messages”. We will use this class attribute for styling, and hiding by default, the error messages using CSS (see lines <i>12-20</i>, <i>line 13</i> hides the messages by default),</li>
  <li><i>Lines 97-102</i> look at all forms in the document and call a function that will replace the default validation behavior for all of them: the replaceValidationUI(form) function,</li>
  <li>This function first disables all default behavior (no more display of bubbles during form submission), this is done at <i>lines 45-57</i>,</li>
  ...
  <li><i>Lines 76-83</i>: For each invalid field, we get the value of the name attribute of the corresponding label, we also get the validation error message, and we build a list item(&lt;li&gt;…&lt;/li&gt;),</li>
  <li><i>Line 86</i>: Then we add this list element (a formatted error message corresponding to an invalid input field) to the error message container,</li>
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image295.webp?raw=true"
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image296.webp?raw=true"
  alt="Key value pairs."
  style="width:17%;" />
...
11. var location = localStorage.location;</pre>

</details>

<p>This data is located in a store attached to the origin of the page.
We created <a href="https://jsbin.com/povuqa/1/edit" target="_blank" rel="noopener noreferrer">a JSBin example in
which we included the above code</a>.</p>
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image297.webp?raw=true"
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image298.webp?raw=true"
...
<ul>
  <li>From W3C’s specification: <a href="https://www.w3.org/TR/webstorage/" target="_blank" rel="noopener noreferrer">The W3C Web Storage API recommendation</a><br></li>
  <li>An Interesting article on Web.dev: <a href="https://web.dev/storage-for-the-web/" target="_blank" rel="noopener noreferrer">Storage for the Web</a><br></li>
  <li>From MDN’s Web Docs: <a href="https://developer.mozilla.org/en-US/docs/Web/API/Web_Storage_API" target="_blank" rel="noopener noreferrer">Web Storage API</a></li>
</ul>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
...
<ul>
  <li><b>Save with the localStorage.key = value syntax. </b>For example, localStorage.firstName = ‘Michel’ will save the value “Michel” with the access key being ‘firstName’<br></li>
  <li><b>Restore with the var value = localStorage.key syntax</b>. For example, var fn = localStorage.firstName; will set fn with the value ‘Michel’ if this value has been previously saved as in the example from the line above.</li>
</ul>

<h4>Saving the form content on the fly</h4>

<p>Open this <a href="https://jsbin.com/pulurir/edit?html,js,output" target="_blank" rel="noopener noreferrer">online example at JSBin</a>, and use F12 or cmd-alt-i (Mac OS) to look at the dev. tools. As you type in the different input fields, their content is updated in the localStorage.<br>
We just added input event listeners to each input field. For example, in order to save the first name input field’s content, we just added:</p>
...
<p>This time, we want the form content to be restored on page
load/reload. We will add a restoreFormContent() function in the
JavaScript code that will be called each time the page is loaded. In
this function, we will read the saved data and set the input fields’
values.</p>
<p><a href="https://jsbin.com/yivocuz/edit?html,js,output" target="_blank" rel="noopener noreferrer">Complete
example on JSBin</a>: enter data and press reload at any time. The form
content is restored!</p>
...
<pre>1.  // Called when the page is loaded
...
<pre>1. var counter = localStorage.getItem(&quot;count&quot;) || 0;
2. counter++;
3. localStorage.setItem(&quot;count&quot;, counter);</pre>

<p>As you can easily guess from the above, we use var value =
...
except that this time:</p>

<ul>
  <li>The key can contain spaces, for example we can write: localStorage.setItem(“Instructor’s name”, “Michel”); and var name =  localStorage.getItem(“Instructor’s name”);, while var name = localStorage.Instructor’s name; will not work!</li>
  <li>In a loop or in an iterator, sometimes we need to set/get localStorage values using this syntax, for example:</li>
</ul>

<pre>1.  var inputField = document.getElementById(&quot;firstName&quot;);
...
purposes!). The following code lists everything in the current
store:</p>

<pre>1. for (var i = 0, n = localStorage.length; i &lt; n; i++) {
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image300.webp?raw=true"
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image301.webp?raw=true"
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image302.webp?raw=true"
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image303.webp?raw=true"
...
<p><a href="https://jsbin.com/cebavo/edit?html,js,console,output" target="_blank" rel="noopener noreferrer">Here
is a modified example that saves/restores its state, you can try it
...
<pre>1. function initPreferences() {
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<p><a href="https://jsbin.com/zowise/edit?html,js,output" target="_blank" rel="noopener noreferrer">Online example at JSBin</a></p>
...
<pre>1. function addInputListener(inputField) {
...
<pre>1. function restoreFormContent() {
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image304.webp?raw=true"
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image305.webp?raw=true"
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image306.webp?raw=true"
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image307.webp?raw=true"
  alt="localStorage view in devtools shows the data."
  style="width:65%;" />

<p>The source code for this example is a bit long, and we suggest that you examine it in the JS Bin tool. We extensively commented it. It uses:</p>
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image308.webp?raw=true"
...
href="https://chrome.google.com/webstore/detail/remo-music-player/ajilpdcmebalpffmjjopcingplogifhb" 
  target="_blank" rel="noopener noreferrer">Remo Music
player</a> below, or an application that edits the audio content of
local mp3 files, for example, the <a
href="https://wav.hya.io/#/fx" target="_blank" rel="noopener noreferrer">HYA-WAVE sound editor</a> (screenshot
above).</p>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~~~~~ 309. audio player that plays local files (370) ~~~~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image309.webp?raw=true"
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image310.webp?raw=true"
...
<p>I’m going first to show you some example of server less
applications.</p>
...
<p>I’m going to explain with the source code here because it’s
simpler.</p>
...
<p>What we do in that example, is that we create a &lt;span&gt;. In the span
with the innerHTML, we add an image that has for src attribute the
content of the image we read as a data URL.</p>
<p>And finally, we just insert this image in the document and this is
when we see it.</p>
<p>I’m going to live code this one, maybe a simpler version so that you
...
<p>And I’m going to pass the set of file descriptors that have been
selected: ‘this.files’ is the correct way to send the selected files to
a Javascript function.</p>
<p>Now, I’m going to start writing some script. But before, I will add a
space, let’s say ‘div id=thumbnails’.</p>
<p>This is an empty container that will be used for inserting the
preview of the images.</p>
<p>Now I’m going in the script part. In the script part, we’re going to
write this function ‘readImagesAndPreview()’ and it takes as parameter
the files that will be sent.</p>
<p>And here if I want just to read the first file I will just show you
how it works. I create a reader object, like that, and I ask the reader
to ‘readAsDataURL’ the first file.</p>
<p>What is happening is that this may take some time and I need to
declare, before reading the files, a callback that will be code only
once the file would have been read - ‘reader.onload’</p>
<p>And here, what can I do with the file that has been read, I will
create an image element.</p>
<p>So i created an image element, I set the source of this element with
the file content that is in the ‘e.target.value’. So I created an image.
...
and I add the image I created.</p>
<p>Let’s try it, maybe I made some mistakes. I select several files, I
open them and here, apparently, I make a small mistake.</p>
<p>Let’s open an image and now read the image and I can see the
preview.</p>
<p>If you look carefully, it’s just a few lines of code.</p>
<p>So now I’m going to show you how we could work with not only one
single image, but several images. The trick consists in adding a ‘for’
loop.</p>
<p>We will iterate on the length of the file’s variable here. If we got
3 files, we do 3 loops. I’m going to define a variable called ‘f’ that
will correspond to the current file.</p>
<p>What we are going to read this time is the current file ‘f’.</p>
<p>So this loop here, will first read files, for each one we do read as
data URL, when the file is read we enter the onload callback, we create
an image with the result.</p>
<p>I’m going just to add some constraints on the size, because when I
tried earlier I had big images that could not fit on the screen.</p>
...
<p>I can see the two pictures. If I select more, then I can see the
whole set of pictures that are coming as previews.</p>
<p>You can see that the number of lines of code is really small and this
is quiet powerful.</p>
...
store.</p>
<p>I installed one that is called Polarr that is using HTML for all the
...
on, and finally you can export it and that’s all.</p>
<p>All this here is HTML5, this is canvas, these are form elements we
saw the last week, some canvas here, or image elements and so on.</p>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 311. image previews (374) ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image311.webp?raw=true"
  alt="Image preview."
  style="width:65%;" />
...
<p><a href="https://jsbin.com/terocu/edit?html,output" target="_blank" rel="noopener noreferrer">Here is a
complete example on JSBin</a> that uses the code above to get details
...
<pre>1.  &lt;p&gt;Select several images: &lt;input
...
<ul>
  <li><i>Line 1:</i> we used the multiple attribute to allow the selection of multiple files in the file chooser (using shift or control keys). The accept=“image/” attribute is a filter that restricts selection to images only. Finally, the onchange listener will call the filesProcess(…) function, passing as parameter the list of selected files for the current element (this.files).<br></li>
  <li><i>Lines 9 and 13:</i> we prepare the HTML code for building a &lt;table&gt; with the results.<br></li>
  <li><i>Line 7:</i> this for loop builds all the rows that compose the table, adding HTML code to  the selection string variable. At the end of the loop, this variable contains all the HTML code that corresponds to the table of results.<br></li>
  <li><i>Line 14:</i> the table is added to the page. We use the innerHTML attribute of the DOM element corresponding to the &lt;div id=“result”&gt; in order to insert the table as its child in the DOM tree. As such, the table appears on the page dynamically.</li>
</ul>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<h3 id="ch6-3-4">6.3.4 Blob and File</h3>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<p>The <a href="https://www.w3.org/TR/FileAPI/" target="_blank" rel="noopener noreferrer">HTML5 File API
specification</a> introduces several interfaces:</p>

<ul>
  <li>the <a href="https://www.w3.org/TR/FileAPI/#filelist-section" target="_blank" rel="noopener noreferrer">FileList</a>interface (we already met it) the files property is a FileList,</li>
  <li>the <a href="https://www.w3.org/TR/FileAPI/#file-section" target="_blank" rel="noopener noreferrer">File</a> interface that is useful for getting details about a file (the file variable in the for loop of the last example illustrates this),</li>
  <li>the <a href="https://www.w3.org/TR/FileAPI/#blob-section" target="_blank" rel="noopener noreferrer">Blob</a> interface helps read binary data (only) that is accessed slice by slice (as chunks of data, each one being a “Blob”), </li>
  <li>and the <a href="https://www.w3.org/TR/FileAPI/#APIASynch" target="_blank" rel="noopener noreferrer">FileReader</a> interface for reading file content (we will see how to use it in the next section of the course).</li>
</ul>

<p>We will not use all of these interfaces, but let’s explain the
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image312.webp?raw=true"
...
href="https://jsbin.com/jefitop/1/edit?html,output" target="_blank" rel="noopener noreferrer">here is an example
“as is” that shows how to download an image using Xhr2</a> (Xml Http
...
href="https://www.edx.org/course/html5-apps-and-games" target="_blank" rel="noopener noreferrer">W3C HTML5 Apps and Games</a> course.</p>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
...
<pre>1.  function readFileContent(f) {
...
a &lt;input type=“file” id=“file” onchange=“readFileContent(this.files)”/&gt;, and by choosing a file.
</p>

<ul>
  <li><i>Line 11</i> is executed first, and asks the Reader object to read the file f as text. 
    As this takes some time, it’s an asynchronous operation that will be executed by the browser in the background. 
    When the file is read, the reader.onload callback function is called.</li>
  <li><i>Line 4</i> is executed after <i>line 11</i>, and is called only when the file content is available. 
    This callback takes an event e as a unique parameter, and e.target.result is the file content.</li>
</ul>
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image313.webp?raw=true"
...
<p><a href="https://jsbin.com/xewemi/edit?html,output" target="_blank" rel="noopener noreferrer">Example at
JSBin</a>, or try it below in your browser:</p>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~ 314. read single files content (379) ~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image314.webp?raw=true"
...
<p><a href="https://jsbin.com/zaheyu/edit?html,output" target="_blank" rel="noopener noreferrer">Example on
JSBin</a>, or try it below in your browser. This time, please select
multiple text files (using shift for multiple selection):</p>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~~~~~~~~~ 315. choose multiple text files (380) ~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image315.webp?raw=true"
...
<p><a href="https://jsbin.com/xepexuy/1/edit?html,output" target="_blank" rel="noopener noreferrer">Example on JSBin</a> (does not work on IE, as it does not support the WebAudio API). We could not embed it here on the edX platform as it prevents code that uses Ajax to run in its pages.</p>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~ 316. webaudio api - does not work with microsoft shit (382) ~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image316.webp?raw=true"
...
<details>
  <summary>Webaudio API</summary>

<pre>1.  // User selects file. Read it as an ArrayBuffer and pass to the API.
...
<ul>
  ...
  <li><i>Line 9:</i> when a user chooses a file, the listener will be executed. 
    Line 9 will start the reading of the file content, as a binary file (this is what readAsArrayBuffer means: 
    read as binary!). Once the file will be entirely read, the onload callback will be asynchronously called by the browser.</li>
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image317.webp?raw=true"
...
with https://</p>
<p>In your browser, you will see a small red circle rendered by this source
code:</p>
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image318.webp?raw=true"
  alt="Red splotch."
  style="width:15%;" />
...
files, such as <a href="https://ezgif.com/image-to-datauri" target="_blank" rel="noopener noreferrer">Image to Data URI converter</a> (screenshot below):</p>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~ 319. Online service that converts uploaded images to data uris... ~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~ we see an image and its ascii encoded data uri version (384) ~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image319.webp?raw=true"
...
<p>This first example is useful for forms that allow the user to select one or more pictures. Before sending the form, you might want to get a preview of the pictures in the HTML page.
The reader.readAsDataUrl method is used for that.</p>
<p><a href="https://jsbin.com/laseye/edit?html,output" target="_blank" rel="noopener noreferrer">Example on JSBin</a> or try it below in your browser:</p>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~~~~~~~~~ 332. preview of selected images (385) ~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image332.webp?raw=true"
...
<pre>1.  &lt;label for=&quot;files&quot;&gt;Choose multiple files:&lt;/label&gt;
...
<ul>
  ...
  <li><i>Lines 24-30:</i> we build, using the DOM API, a &lt;span class="thumb"&gt;…&lt;/span&gt; and inside we add an &lt;img src=the data url&gt; element with its src attribute equal to the url of the image that has been read (the image content as dataURL is in e.target.result). Finally, at <i>line 27</i>, we insert the span in the document before the current children of the &lt;output id="list"&gt;  element (declared at <i>line 5</i>).</li>
</ul>
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image322.webp?raw=true"
...
<pre>1. function drawImage(imageFile) {
...
<p><a href="https://gianablantin.github.io/CanvasFilters/" target="_blank" rel="noopener noreferrer">Try this example online on gitHub</a>.</p>
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image323.webp?raw=true"
...
<a href="https://caniuse.com/#feat=geolocation" target="_blank" rel="noopener noreferrer">Browser support for the Geolocation API</a> is excellent, both on mobile and on desktop devices.</p>
...
<p><a href="https://jsbin.com/toyeley/1/edit?html,output" target="_blank" rel="noopener noreferrer">This online example at JSBin</a> shows how to get the current longitude and latitude and display them in an HTML page. Try it below in your browser:</p>
<p>Click the button to get your coordinates:</p>
<p>Where am I ?</p>
<p>Note that the first time you execute this example, for privacy reasons,
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image324.webp?raw=true"
...
<ul>
  <li>The W3C specification: <a href="https://www.w3.org/TR/geolocation-API/" target="_blank" rel="noopener noreferrer">Geolocation API</a></li>
  <li>MDN’s Web Docs: <a href="https://developer.mozilla.org/en-US/docs/Web/API/Geolocation_API" target="_blank" rel="noopener noreferrer">Geolocation API</a></li>
  <li>Browser support tables:<br>
  <ul>
    <li>on CanIuse: <a href="https://caniuse.com/#feat=geolocation" target="_blank" rel="noopener noreferrer">Geolocation</a></li>
    <li>on MDN: <a href="https://developer.mozilla.org/en-US/docs/Web/API/Geolocation_API#Browser_compatibility" target="_blank" 
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image325.webp?raw=true"
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image326.webp?raw=true"
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<p>In order to track the current position, the geolocation API provides a method similar to the getCurrentPosition(onSuccess, onError) 
named watchPosition(onSuccess, onError).</p>
<p>When getCurrentPosition gives a position when called, watchPosition does the following:</p>

<ul>
  <li>It gets the callback function only when the current position changes. If you stay in the same location, 
    the callback function won’t be called regularly.</li>
  <li>It returns an id so that you can use the clearWatch(id) method to stop the current tracking.</li>
</ul>
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image327.webp?raw=true"
...
<pre>1. // Just ask to turn GPS on, if available
...
17.   {enableHighAccuracy:true, maximumAge:30000, timeout:27000});</pre>
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<p>This section presents an example of how to get an interactive map, using <a href="https://leafletjs.com/reference-1.6.0.html" target="_blank" rel="noopener noreferrer">
  the Leaflet API for OpenStreetMap</a>, and gives links to more resources. 
  Did you know that you can even get an estimation of a physical address from the longitude and latitude, using online Web services?</p>
<p>How to get a map centered on your longitude and latitude.</p>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 328. openstreetmap test (393) ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image328.webp?raw=true"
  alt="Example/Test OpenStreetMap."
  style="width:85%;" />

<p>This example is just given "as is", as there are so many possibilities for rendering a map with <a href="/leafletjs.com/reference-1.6.0.html" 
  target="_blank" rel="noopener noreferrer">the Leaflet API for OpenStreetMaps</a>https:/. However, we think having such a basic example might be useful.</p>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 329. openstreetmap test (393) ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image329.webp?raw=true"
  alt="Example/Test OpenStreetMap."
  style="width:50%;" />
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image330.webp?raw=true"
...
<p>Gisgraphy (free service) reverse geocoding example (screenshot only, click on it to see <a href="https://services.gisgraphy.com/static/leaflet/index.html" target="_blank" rel="noopener noreferrer"> the demo on the Gisgraphy website</a>):</p>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 331. gisgraphy screenshot (398) ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<img class="displayed"
  src="./images/image331.webp?raw=true"
  alt="Gisgraphy screenshot."
  style="width:65%;" />
  
<h4><b>Example #2:</b> reverse geocoding + OpenStreetMap</h4>

<p><b>Important note:</b> these examples below rely on an external <a href="https://github.com/perliedman/leaflet-control-geocoder" target="_blank" rel="noopener noreferrer">GitHub resource</a>.</p>
...
<p>This is just a variation of the previous examples. We embedded the interactive map in a form, and we display the results of the reverse geocoder in a form field. This example might be useful if you want to pre-fill the address of a registration form, depending on the current location of the person who is registering.</p>

<p>Click on the Codepen logo (on the top right) so to run the <a href="https://codepen.io/w3devcampus/pen/MWKEJqM" target="_blank" rel="noopener noreferrer">online example</a> (for security reasons the embedded version cannot run in this page):</p>
...
<h5>. . .The end.<br>
<br>last updated 07-31-23 Mon 8:46am</h5>
  </body>
</html>
